...
import { checkPermFromRole, ActionPerm } from "../../API/permissions.js";
    ...
    return (
        <div className="container-fluid p-5">
            <div className="row justify-content-between">
                <h3 className="col-6 large-title">Swot Analizi Formatı</h3>
                <div className="col-6 row justify-content-end" style={{columnGap: '10px'}}>
                    ...
                    {mode === "viewRevision" && data != null && (
                        <>
                            <button className="col-2 print-btn2 success-btn-1"
                                    onClick={() => onRevisionResult(false)}>Onayla
                            </button>
                            <button className="col-2 print-btn2 danger-btn-1"
                                    onClick={() => onRevisionResult(true)}>Reddet
                            </button>
                        </>
                    )}
                ...
                <div className="col-4">
                    <div className="card" style={{position: 'sticky', top: '100px'}}>
                        ...
                        <div className="card-body justify-content-center row">
                            <div className="col-12 row p-3" style={{borderBottom: '1px solid #ccc'}}>
                                <label className="col-12 create-doc-p mb-3">Başlık</label>
                                <input
                    ...
                    <div className="card">
                        ...
                        <div className="card-body justify-content-center row">
                            <div className="row justify-content-center col-12 p-3"
                                 style={{borderBottom: '1px solid #ccc'}}>
                                <p className="create-doc-p">Kurumiçi faktörlerin güçlü yönlerini yazınız.</p>
                                <textarea className="col-12 create-doc-textarea" name="purpose" type="text"
                                          field-short-name="field1"/>
                            </div>
                            <div className="row justify-content-center col-12 p-3"
                                 style={{borderBottom: '1px solid #ccc'}}>
                                <p className="create-doc-p">Kurumiçi faktörlerin zayıf yönlerini yazınız.</p>
                                <textarea className="col-12 create-doc-textarea" name="scope" type="text"
                                          field-short-name="field2"/>
                            </div>
                            <div className="row justify-content-center col-12 p-3"
                                 style={{borderBottom: '1px solid #ccc'}}>
                                <p className="create-doc-p">Kurumdışı faktörlerin fırsatlarını yazınız.</p>
                                <textarea className="col-12 create-doc-textarea" name="definitions" type="text"
                                          field-short-name="field3"/>
                            </div>
                            <div className="row justify-content-center col-12 p-3">
                                <p className="create-doc-p">Kurumdışı faktörlerin tehditlerini yazınız.</p>
                                <textarea className="col-12 create-doc-textarea" name="responsibilities" type="text"
