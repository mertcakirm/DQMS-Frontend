                ...
                <div className="popup-content">
                    ...
                    <div>
                        <div className="row p-5">
                            ...
                            <div className="col-6 row" style={{padding: '10px 40px '}}>
                                <label className="purple-text">Departman</label>
                                <select
                                    className="create-doc-inp col-12" value={unit}
                            ...
                            <div className="col-12 row" style={{padding: '10px 40px '}}>
                                <label className="purple-text">Kalite</label>
                                <input className="create-doc-inp" type="number" field-short-name="field1"/>
                            </div>
                            <div className="col-12 row" style={{padding: '10px 40px '}}>
                                <label className="purple-text">Çevre</label>
                                <input className="create-doc-inp" type="text" field-short-name="field2"/>
                            </div>
                            <div className="col-12 row" style={{padding: '10px 40px '}}>
                                <label className="purple-text">İSG</label>
                                <input className="create-doc-inp" type="date" field-short-name="field3"/>
                            </div>
