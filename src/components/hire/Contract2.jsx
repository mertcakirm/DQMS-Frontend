...
const Contract2 = () => {
  ...
  const handleSubmit = () => {
    (async () => {
      ...
      documentFields["taraflar-ve-ofisler"] = JSON.stringify(state);
  ...
  return (
    <div className="container-fluid p-5">
      <div className="row justify-content-between">
        <h3 className="col-3 large-title">Sözleşme 2</h3>
        <div
        ...
        <div className="col-8">
          <div className="card" style={{ position: "sticky", top: "100px" }}>
            ...
            <div className="card-body justify-content-center row">
              ...
              >
                <p className="create-doc-p col-6">
                  Madde 3. Kiralanan Ofise Ait Bilgiler
                </p>
                <button
                  onClick={() => addNewRow("office")}
                  className="print-btn2 col-3"
                >
                  + Ofis Ekle
                </button>
              ...
              <div
                ...
                style={{ borderBottom: "1px solid #ccc" }}
              >
                <p className="create-doc-p">Madde 4. Yükümlülükler</p>
                <textarea
                  className="col-12 create-doc-textarea"
              ...
              <div
                ...
                style={{ borderBottom: "1px solid #ccc" }}
              >
                <p className="create-doc-p">Madde 5.</p>
                <textarea
                  className="col-12 create-doc-textarea"
              ...
              <div className="row justify-content-center col-12 p-3">
                <p className="create-doc-p">Madde 6.</p>
                <textarea
                  className="col-12 create-doc-textarea"
