...
const ApplicationEvaluationForm = () => {
    ...
    const [tableData, setTableData] = useState(
        Array.from({ length: 10 }, () => Array(7).fill(""))
    );
        ...
        <div className="container-fluid p-5">
            ...
            <div className="row mt-5">
                ...
                <div className="col-12 mt-5">
                    <div className="card" style={{position: 'sticky', top: '100px'}}>
                        <div className="card-header create-doc-card-header" style={{height: '50px'}}>
                        </div>
                        <div className="card-body justify-content-center px-5 row">
                            <div className="row col-12 py-3 justify-content-between row-gap-4"
                            ...
                            <div className="col-12 row justify-content-center">
                                ...
                                <div className="row" style={{padding: "20px", fontFamily: "Arial, sans-serif"}}>

                                    <div className="row col-12 justify-content-between">
                                        <h2 className="col-4">Puan Girişi</h2>

                                        <div className="col-8 row align-items-center justify-content-end"
