    ...
    (async () => {
      ...
      if (mode === DMode.Create) {
        await createDocument({
          title: title,
          shortName: "document",
          type: DocumentType.MeetingMinutes,
          department: unit,
  ...
  return (
    <div className="container-fluid p-5">
      <div className="row justify-content-between">
        <h3 className="col-6 large-title">Toplantı Tutanak Formu</h3>
        <div
          ...
          <div className="card" style={{ position: "sticky", top: "100px" }}>
            ...
            <div className="card-body justify-content-center px-5 row">
              ...
              <div className="col-12">
                ...
                >
                  <p className="create-doc-p col-6">A MADDESİ KARARLARI</p>
                  <button
                    onClick={() => addNewRow("A")}
                ...
                <div
                  ...
                  style={{ borderBottom: "1px solid #ccc" }}
                >
                  <p className="create-doc-p col-6">B MADDESİ KARARLARI</p>
                  <button
                    onClick={() => addNewRow("B")}
                    className="print-btn2 col-3"
                  >
                ...
                <div
                  ...
                  style={{ borderBottom: "1px solid #ccc" }}
                >
                  <p className="create-doc-p col-6">C MADDESİ KARARLARI</p>
                  <button
                    onClick={() => addNewRow("C")}
                    className="print-btn2 col-3"
                  >
                ...
                <div
                  ...
                  style={{ borderBottom: "1px solid #ccc" }}
                >
                  <p className="create-doc-p col-6">D MADDESİ KARARLARI</p>
                  <button
                    onClick={() => addNewRow("D")}
                    className="print-btn2 col-3"
                  >
                ...
                <div
                  ...
                  style={{ borderBottom: "1px solid #ccc" }}
                >
                  <p className="create-doc-p col-6">E MADDESİ KARARLARI</p>
                  <button
                    onClick={() => addNewRow("E")}
                    className="print-btn2 col-3"
                  >
                ...
                <div className="row justify-content-between align-items-center col-12 p-3">
                  <p className="create-doc-p col-6">Görüşe Katılanlar</p>
                  <div>
                    <table
                      style={{
                        width: "100%",
