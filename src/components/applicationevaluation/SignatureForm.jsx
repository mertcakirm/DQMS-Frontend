...
const SignatureForm = () => {
  ...
  const handleSubmit = () => {
    (async () => {
      ...
      documentFields["signlist"] = JSON.stringify(state);
  ...
  if (mode !== DMode.Create) {
    ...
    useEffect(() => {
      (async () => {
        ...
        setState(JSON.parse(doc.fields["signlist"].value));
  ...
  return (
    <div className="container-fluid p-5">
      <div className="row justify-content-between">
        <h3 className="col-6 large-title">İmza Formu</h3>
        <div
                  ...
                  <div>
                    ...
                    >
                      <thead>
                        ...
                        >
                          <td className="text-center">Sıra No</td>
                          <td className="text-center">X Adı</td>
                          <td className="text-center">Y Adı</td>
                          <td className="text-center">Katılımcı</td>
                          <td className="text-center">İmza</td>
                        </tr>
                      </thead>
                      <tbody>
                        {state.row.map((item, index) => (
                          <tr key={item.id}>
                            <td
                              style={{
                                border: "1px solid #ccc",
