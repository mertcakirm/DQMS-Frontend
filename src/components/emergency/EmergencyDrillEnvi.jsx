    ...
    (async () => {
      ...
      if (mode === DMode.Create) {
        const documentId = await createDocument({
          title: title,
          shortName: "document",
          type: DocumentType.EmergencyDrillEnvi,
          department: unit,
    ...
    <div className="container-fluid p-5">
      <div className="row justify-content-between">
        <h3 className="col-6 large-title">
          Acil Durum Tatbikat Değerlendirme Formu Çevre
        </h3>
        <div
        ...
        <div className="col-8">
          <div className="card mb-5">
            ...
            <div className="card-body justify-content-center row">
              ...
              <div
                  className="row justify-content-center col-12 p-3">
                <p className="create-doc-p">3. YASAL DAYANAK</p>
                <textarea
                    className="col-12 create-doc-textarea"
                    name="definitions"
                    type="text"
          ...
          <div className="card mb-5">
            ...
            <div className="card-body justify-content-center row">
              <div
                  ...
                  style={{borderBottom: "1px solid #ccc"}}
              >
                <p className="create-doc-p">Başarılı Yönleri</p>
                <textarea
                    className="col-12 create-doc-textarea"
                    name="purpose"
                    type="text"
              ...
              <div
                  ...
                  style={{borderBottom: "1px solid #ccc"}}
              >
                <p className="create-doc-p">Geliştirmeye Açık Yönleri</p>
                <textarea
                    className="col-12 create-doc-textarea"
                    name="scope"
                    type="text"
              ...
              <div className="col-12 p-3 row">
                <label className="col-3 create-doc-p">
                  Tatbikatı Puanlayın
                </label>
                <select className="col-3" field-short-name="select1">
          ...
          <div className="card mb-5">
            ...
            <div className="card-body justify-content-center row">
              <div
                  ...
                  style={{borderBottom: "1px solid #ccc"}}
              >
                <p className="create-doc-p">Süreç Adı</p>
                <input
                    className="col-12 create-doc-inp"
                    type="text"
              ...
              <div
                  className="row col-12 p-3"
                  style={{borderBottom: "1px solid #ccc"}}
              >
                <label className="col-3 create-doc-p">Sorumlu Birim</label>
                <select className="col-3" field-short-name="select2">
                  {optionsList.map((option, index) => (
                      <option key={index} value={option}>
                        {option}
                      </option>
              ...
              <div
                  ...
                  style={{borderBottom: "1px solid #ccc"}}
              >
                <p className="create-doc-p">Başlangıç Tarihi</p>
                <input
                    className="col-12 create-doc-inp"
                    type="date"
              ...
              <div
                  ...
                  style={{borderBottom: "1px solid #ccc"}}
              >
                <p className="create-doc-p">Bitiş Tarihi</p>
                <input
                    className="col-12 create-doc-inp"
                    type="date"
...
export default EmergencyDrillEnvi;
