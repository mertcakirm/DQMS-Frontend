    ...
    (async () => {
      ...
      if (mode === DMode.Create) {
        const documentId = await createDocument({
          title: title,
          shortName: "document",
          type: DocumentType.PrivacyCommitment,
          department: unit,
  ...
  return (
    <div className="container-fluid p-5">
      <div className="row justify-content-between">
        <h3 className="col-3 large-title">Gizlilik Taahütnamesi</h3>
        <div
          ...
          <div className="card">
            ...
            <div className="card-body justify-content-center row">
              <div
                ...
                style={{ borderBottom: "1px solid #ccc" }}
              >
                <p className="create-doc-p">1.Gizli Bilginin Tanımı </p>
                <textarea
              ...
              <div
                ...
                style={{ borderBottom: "1px solid #ccc" }}
              >
                <p className="create-doc-p">2.İstisnai Durumlar</p>
                <textarea
                  className="col-12 create-doc-textarea"
              ...
              <div
                ...
                style={{ borderBottom: "1px solid #ccc" }}
              >
                <p className="create-doc-p">3.Gizlilik Taahhüdü(Taahüt Eden)</p>
