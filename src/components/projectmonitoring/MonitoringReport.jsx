    ...
    (async () => {
      if (mode === "create") {
        await createDocument({
          type: DocumentType.MonitoringReport,
          shortName: "document",
          title: title,
  ...
  return (
    <div className="container-fluid p-5">
      <div className="row justify-content-between">
        <h3 className="col-3 large-title">Proje İzleme Raporu</h3>
        <div
      ...
      <div className="row col-12 mt-3 px-5 justify-content-center column-gap-3">
