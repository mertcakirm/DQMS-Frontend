      ...
      try {
        if (mode === DMode.Create) {
          await createDocument({
            type: DocumentType.ArchiveDoc,
            shortName: "document",
            title: "Doküman Arşiv Süresi Formu",
  ...
  return (
    <div>
      <div className="popup-overlay">
        <div className="popup-content" style={{ height: "500px" }}>
          <h4 className="large-title">Yeni Doküman Ekle</h4>
          <div>
            <div className="row p-5">
              <div className="col-6 row" style={{ padding: "10px 40px " }}>
                <label className="purple-text">Ait Olduğu Birim</label>
              ...
              <div className="col-6 row" style={{ padding: "10px 40px " }}>
                <label className="purple-text">Kalite Kaydı</label>
                <input
                  className="create-doc-inp"
              ...
              <div className="col-6 row" style={{ padding: "10px 40px " }}>
                <label className="purple-text">Arşiv Süresi</label>
                <input
                  className="create-doc-inp"
              ...
              <div className="col-6 row" style={{ padding: "10px 40px " }}>
                ...
                <select
                  className="col-12 mt-3 create-doc-inp"
...
export default ArchiveDurationPopup;
