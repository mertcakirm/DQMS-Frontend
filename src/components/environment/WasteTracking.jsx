...
const WasteTracking = () => {
  ...
  return (
    <div className="container-fluid p-5">
      ...
      >
        <h3 className="col-6 large-title">Atık Takip Formu</h3>
        <div
          ...
          <div className="card" style={{ position: "sticky", top: "100px" }}>
            ...
            <div className="card-body justify-content-center row">
              ...
              >
                ...
                <select className="col-12" field-short-name="select1">
                  <option value="Tehlikeli">Tehlikeli</option>
                  <option value="Tehlikesiz">Tehlikesiz</option>
                </select>
              </div>
              <div
                className="row mb-3 justify-content-center col-12 pb-3"
                style={{ borderBottom: "1px solid #ccc" }}
              >
                <label className="col-12 create-doc-p mb-3">Atık Tarihi</label>
                <input
                  className="col-12 create-doc-inp"
                  type="date"
              ...
              >
                <label className="col-12 create-doc-p mb-3">
                  Atık Kodu (Tehlikeli ise giriniz)
                </label>
                <input
                  className="col-12 create-doc-inp"
                  type="text"
              ...
              <div
                ...
                style={{ borderBottom: "1px solid #ccc" }}
              >
                <label className="col-12 create-doc-p mb-3">Atık Adı</label>
                <input
                  className="col-12 create-doc-inp"
                  type="text"
              ...
              <div
                ...
                style={{ borderBottom: "1px solid #ccc" }}
              >
                <label className="col-12 create-doc-p mb-3">Atık Miktarı</label>
                <input
                  className="col-12 create-doc-inp"
                  type="number"
              ...
              >
                <label
                  className="col-12 create-doc-p mb-3"
                  field-short-name="select2"
                >
                  Atık Birimi
                </label>
                <select className="create-doc-inp">
                  {optionsList.map((option, index) => (
                    <option key={index} value={option}>
                      {option}
                    </option>
