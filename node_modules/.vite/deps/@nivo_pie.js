...
function hue2rgb(p4, q4, t7) {
  if (t7 < 0)
    t7 += 1;
  if (t7 > 1)
    t7 -= 1;
  if (t7 < 1 / 6)
    return p4 + (q4 - p4) * 6 * t7;
  if (t7 < 1 / 2)
    return q4;
  if (t7 < 2 / 3)
    return p4 + (q4 - p4) * (2 / 3 - t7) * 6;
  return p4;
}
function hslToRgb(h3, s4, l3) {
  const q4 = l3 < 0.5 ? l3 * (1 + s4) : l3 + s4 - l3 * s4;
  const p4 = 2 * l3 - q4;
  const r4 = hue2rgb(p4, q4, h3 + 1 / 3);
  const g3 = hue2rgb(p4, q4, h3);
  const b4 = hue2rgb(p4, q4, h3 - 1 / 3);
...
var AnimatedStyle = class extends AnimatedObject {
  constructor({ x: x5, y: y4, z: z5, ...style }) {
    const inputs = [];
    const transforms = [];
    if (x5 || y4 || z5) {
      inputs.push([x5 || 0, y4 || 0, z5 || 0]);
      transforms.push((xyz) => [
...
function v() {
  return v = Object.assign ? Object.assign.bind() : function(t7) {
    for (var i4 = 1; i4 < arguments.length; i4++) {
      var o4 = arguments[i4];
      for (var n4 in o4) Object.prototype.hasOwnProperty.call(o4, n4) && (t7[n4] = o4[n4]);
    }
    return t7;
...
var b = (0, import_react15.memo)(function(t7) {
  var o4, n4 = t7.position, r4 = t7.anchor, e7 = t7.children, l3 = zt(), d3 = Ur(), y4 = d3.animate, f3 = d3.config, b4 = kt(), g3 = b4[0], w4 = b4[1], T3 = (0, import_react15.useRef)(false), C5 = void 0, E5 = false, P3 = w4.width > 0 && w4.height > 0, j4 = Math.round(n4[0]), N4 = Math.round(n4[1]);
  P3 && ("top" === r4 ? (j4 -= w4.width / 2, N4 -= w4.height + 14) : "right" === r4 ? (j4 += 14, N4 -= w4.height / 2) : "bottom" === r4 ? (j4 -= w4.width / 2, N4 += 14) : "left" === r4 ? (j4 -= w4.width + 14, N4 -= w4.height / 2) : "center" === r4 && (j4 -= w4.width / 2, N4 -= w4.height / 2), C5 = { transform: m(j4, N4) }, T3.current || (E5 = true), T3.current = [j4, N4]);
  var O4 = useSpring({ to: C5, config: f3, immediate: !y4 || E5 }), V3 = v({}, x, l3.tooltip.wrapper, { transform: null != (o4 = O4.transform) ? o4 : m(j4, N4), opacity: O4.transform ? 1 : 0 });
...
var w = (0, import_react15.memo)(function(t7) {
  var i4, o4 = t7.id, n4 = t7.value, r4 = t7.format, e7 = t7.enableChip, l3 = void 0 !== e7 && e7, a4 = t7.color, c9 = t7.renderContent, h3 = zt(), u3 = Ot(r4);
  if ("function" == typeof c9) i4 = c9();
  else {
    var f3 = n4;
    void 0 !== u3 && void 0 !== f3 && (f3 = u3(f3)), i4 = (0, import_jsx_runtime.jsxs)("div", { style: h3.tooltip.basic, children: [l3 && (0, import_jsx_runtime.jsx)(g, { color: a4, style: h3.tooltip.chip }), void 0 !== f3 ? (0, import_jsx_runtime.jsxs)("span", { children: [o4, ": ", (0, import_jsx_runtime.jsx)("strong", { children: "" + f3 })] }) : o4] });
  }
...
var C = (0, import_react15.memo)(function(t7) {
  var i4, o4 = t7.title, n4 = t7.rows, r4 = void 0 === n4 ? [] : n4, e7 = t7.renderContent, l3 = zt();
...
var E = (0, import_react15.memo)(function(t7) {
  var i4 = t7.x0, n4 = t7.x1, r4 = t7.y0, e7 = t7.y1, l3 = zt(), u3 = Ur(), d3 = u3.animate, y4 = u3.config, f3 = (0, import_react15.useMemo)(function() {
    return v({}, l3.crosshair.line, { pointerEvents: "none" });
  }, [l3.crosshair.line]), x5 = useSpring({ x1: i4, x2: n4, y1: r4, y2: e7, config: y4, immediate: !d3 });
...
var P = (0, import_react15.memo)(function(t7) {
  var i4, o4, n4 = t7.width, r4 = t7.height, e7 = t7.type, l3 = t7.x, a4 = t7.y;
  return "cross" === e7 ? (i4 = { x0: l3, x1: l3, y0: 0, y1: r4 }, o4 = { x0: 0, x1: n4, y0: a4, y1: a4 }) : "top-left" === e7 ? (i4 = { x0: l3, x1: l3, y0: 0, y1: a4 }, o4 = { x0: 0, x1: l3, y0: a4, y1: a4 }) : "top" === e7 ? i4 = { x0: l3, x1: l3, y0: 0, y1: a4 } : "top-right" === e7 ? (i4 = { x0: l3, x1: l3, y0: 0, y1: a4 }, o4 = { x0: l3, x1: n4, y0: a4, y1: a4 }) : "right" === e7 ? o4 = { x0: l3, x1: n4, y0: a4, y1: a4 } : "bottom-right" === e7 ? (i4 = { x0: l3, x1: l3, y0: a4, y1: r4 }, o4 = { x0: l3, x1: n4, y0: a4, y1: a4 }) : "bottom" === e7 ? i4 = { x0: l3, x1: l3, y0: a4, y1: r4 } : "bottom-left" === e7 ? (i4 = { x0: l3, x1: l3, y0: a4, y1: r4 }, o4 = { x0: 0, x1: l3, y0: a4, y1: a4 }) : "left" === e7 ? o4 = { x0: 0, x1: l3, y0: a4, y1: a4 } : "x" === e7 ? i4 = { x0: l3, x1: l3, y0: 0, y1: r4 } : "y" === e7 && (o4 = { x0: 0, x1: n4, y0: a4, y1: a4 }), (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [i4 && (0, import_jsx_runtime.jsx)(E, { x0: i4.x0, x1: i4.x1, y0: i4.y0, y1: i4.y1 }), o4 && (0, import_jsx_runtime.jsx)(E, { x0: o4.x0, x1: o4.x1, y0: o4.y0, y1: o4.y1 })] });
});
...
var V = function(t7) {
  var i4 = (0, import_react15.useState)(N), n4 = i4[0], l3 = i4[1], a4 = (0, import_react15.useCallback)(function(t8, i5, o4) {
    var n5 = i5[0], r4 = i5[1];
    ...
    void 0 === n5 && (n5 = "top");
    var r4 = t7.current.getBoundingClientRect(), e7 = t7.current.offsetWidth, a5 = e7 === r4.width ? 1 : e7 / r4.width, c10 = "touches" in o4 ? o4.touches[0] : o4, s5 = c10.clientX, h3 = c10.clientY, u3 = (s5 - r4.left) * a5, d3 = (h3 - r4.top) * a5;
    "left" !== n5 && "right" !== n5 || (n5 = u3 < r4.width / 2 ? "right" : "left"), l3({ isVisible: true, position: [u3, d3], anchor: n5, content: i5 });
...
function hsla2(h3, s4, l3, a4) {
  if (a4 <= 0) h3 = s4 = l3 = NaN;
  else if (l3 <= 0 || l3 >= 1) h3 = s4 = NaN;
  else if (s4 <= 0) h3 = NaN;
...
function hslConvert(o4) {
  ...
  if (s4) {
    if (r4 === max3) h3 = (g3 - b4) / s4 + (g3 < b4) * 6;
    else if (g3 === max3) h3 = (b4 - r4) / s4 + 2;
    else h3 = (r4 - g3) / s4 + 4;
...
function labConvert(o4) {
  ...
  var r4 = rgb2lrgb(o4.r), g3 = rgb2lrgb(o4.g), b4 = rgb2lrgb(o4.b), y4 = xyz2lab((0.2225045 * r4 + 0.7168786 * g3 + 0.0606169 * b4) / Yn), x5, z5;
  if (r4 === g3 && g3 === b4) x5 = z5 = y4;
  else {
    x5 = xyz2lab((0.4360747 * r4 + 0.3850649 * g3 + 0.1430804 * b4) / Xn);
    z5 = xyz2lab((0.0139322 * r4 + 0.0971045 * g3 + 0.7141733 * b4) / Zn);
  }
  return new Lab(116 * y4 - 16, 500 * (x5 - y4), 200 * (y4 - z5), o4.opacity);
}
...
define_default(Lab, lab, extend(Color, {
  ...
  rgb() {
    var y4 = (this.l + 16) / 116, x5 = isNaN(this.a) ? y4 : y4 + this.a / 500, z5 = isNaN(this.b) ? y4 : y4 - this.b / 200;
    x5 = Xn * lab2xyz(x5);
    y4 = Yn * lab2xyz(y4);
    z5 = Zn * lab2xyz(z5);
    return new Rgb(
      lrgb2rgb(3.1338561 * x5 - 1.6168667 * y4 - 0.4906146 * z5),
      lrgb2rgb(-0.9787684 * x5 + 1.9161415 * y4 + 0.033454 * z5),
      lrgb2rgb(0.0719453 * x5 - 0.2289914 * y4 + 1.4052427 * z5),
      this.opacity
    );
  }
}));
...
define_default(Cubehelix, cubehelix, extend(Color, {
  ...
  rgb() {
    ...
    return new Rgb(
      255 * (l3 + a4 * (A2 * cosh2 + B * sinh2)),
      255 * (l3 + a4 * (C2 * cosh2 + D * sinh2)),
      255 * (l3 + a4 * (E2 * cosh2)),
      this.opacity
    );
  }
...
function rgbSpline(spline) {
  return function(colors3) {
    var n4 = colors3.length, r4 = new Array(n4), g3 = new Array(n4), b4 = new Array(n4), i4, color2;
    for (i4 = 0; i4 < n4; ++i4) {
      color2 = rgb2(colors3[i4]);
      r4[i4] = color2.r || 0;
      g3[i4] = color2.g || 0;
      b4[i4] = color2.b || 0;
    }
...
function decompose_default(a4, b4, c9, d3, e7, f3) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a4 * a4 + b4 * b4)) a4 /= scaleX, b4 /= scaleX;
  if (skewX = a4 * c9 + b4 * d3) c9 -= a4 * skewX, d3 -= b4 * skewX;
  if (scaleY = Math.sqrt(c9 * c9 + d3 * d3)) c9 /= scaleY, d3 /= scaleY, skewX /= scaleY;
  if (a4 * d3 < b4 * c9) a4 = -a4, b4 = -b4, skewX = -skewX, scaleX = -scaleX;
  return {
    translateX: e7,
    translateY: f3,
...
function interpolateTransform(parse, pxComma, pxParen, degParen) {
  ...
  function translate(xa, ya, xb, yb, s4, q4) {
    if (xa !== xb || ya !== yb) {
      ...
      q4.push({ i: i4 - 4, x: number_default(xa, xb) }, { i: i4 - 2, x: number_default(ya, yb) });
    } else if (xb || yb) {
      s4.push("translate(" + xb + pxComma + yb + pxParen);
    }
  }
  function rotate(a4, b4, s4, q4) {
    if (a4 !== b4) {
      if (a4 - b4 > 180) b4 += 360;
      else if (b4 - a4 > 180) a4 += 360;
      q4.push({ i: s4.push(pop(s4) + "rotate(", null, degParen) - 2, x: number_default(a4, b4) });
    } else if (b4) {
      s4.push(pop(s4) + "rotate(" + b4 + degParen);
    }
  }
  function skewX(a4, b4, s4, q4) {
    if (a4 !== b4) {
      q4.push({ i: s4.push(pop(s4) + "skewX(", null, degParen) - 2, x: number_default(a4, b4) });
    } else if (b4) {
  ...
  return function(a4, b4) {
    ...
    translate(a4.translateX, a4.translateY, b4.translateX, b4.translateY, s4, q4);
    rotate(a4.rotate, b4.rotate, s4, q4);
    skewX(a4.skewX, b4.skewX, s4, q4);
    scale(a4.scaleX, a4.scaleY, b4.scaleX, b4.scaleY, s4, q4);
    a4 = b4 = null;
    return function(t7) {
      var i4 = -1, n4 = q4.length, o4;
      while (++i4 < n4) s4[(o4 = q4[i4]).i] = o4.x(t7);
      return s4.join("");
    };
  };
}
...
function hcl2(hue2) {
  return function(start2, end) {
    var h3 = hue2((start2 = hcl(start2)).h, (end = hcl(end)).h), c9 = nogamma(start2.c, end.c), l3 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t7) {
      start2.h = h3(t7);
      start2.c = c9(t7);
      start2.l = l3(t7);
...
function bisector(f3) {
  ...
  function center(a4, x5, lo = 0, hi = a4.length) {
    const i4 = left(a4, x5, lo, hi - 1);
    return i4 > lo && delta(a4[i4 - 1], x5) > -delta(a4[i4], x5) ? i4 - 1 : i4;
  }
...
function blurh(blur3, T3, S4, w4, h3) {
  for (let y4 = 0, n4 = w4 * h3; y4 < n4; ) {
    blur3(T3, S4, y4, y4 += w4, 1);
  }
}
function blurv(blur3, T3, S4, w4, h3) {
  for (let x5 = 0, n4 = w4 * h3; x5 < w4; ++x5) {
    blur3(T3, S4, x5, x5 + n4, w4);
  }
}
function blurfImage(radius) {
  const blur3 = blurf(radius);
  return (T3, S4, start2, stop2, step) => {
    start2 <<= 2, stop2 <<= 2, step <<= 2;
    blur3(T3, S4, start2 + 0, stop2 + 0, step);
    blur3(T3, S4, start2 + 1, stop2 + 1, step);
    blur3(T3, S4, start2 + 2, stop2 + 2, step);
    blur3(T3, S4, start2 + 3, stop2 + 3, step);
  };
}
function blurf(radius) {
  ...
  return (T3, S4, start2, stop2, step) => {
    ...
    let sum3 = radius0 * S4[start2];
    const s0 = step * radius0;
    const s1 = s0 + step;
    for (let i4 = start2, j4 = start2 + s0; i4 < j4; i4 += step) {
      sum3 += S4[Math.min(stop2, i4)];
    }
    for (let i4 = start2, j4 = stop2; i4 <= j4; i4 += step) {
      sum3 += S4[Math.min(stop2, i4 + s0)];
      T3[i4] = (sum3 + t7 * (S4[Math.max(start2, i4 - s1)] + S4[Math.min(stop2, i4 + s1)])) / w4;
      sum3 -= S4[Math.max(start2, i4 - s0)];
    }
  };
}
function bluri(radius) {
  ...
  return (T3, S4, start2, stop2, step) => {
    if (!((stop2 -= step) >= start2)) return;
    let sum3 = radius * S4[start2];
    const s4 = step * radius;
    for (let i4 = start2, j4 = start2 + s4; i4 < j4; i4 += step) {
      sum3 += S4[Math.min(stop2, i4)];
    }
    for (let i4 = start2, j4 = stop2; i4 <= j4; i4 += step) {
      sum3 += S4[Math.min(stop2, i4 + s4)];
      T3[i4] = sum3 / w4;
      sum3 -= S4[Math.max(start2, i4 - s4)];
    }
  };
}
...
function ordinal() {
  ...
  function scale(d3) {
    let i4 = index2.get(d3);
    if (i4 === void 0) {
      if (unknown !== implicit) return unknown;
      index2.set(d3, i4 = domain.push(d3) - 1);
    }
    return range2[i4 % range2.length];
  }
...
function formatDecimalParts(x5, p4) {
  if ((i4 = (x5 = p4 ? x5.toExponential(p4 - 1) : x5.toExponential()).indexOf("e")) < 0) return null;
...
function formatTrim_default(s4) {
  out: for (var n4 = s4.length, i4 = 1, i0 = -1, i1; i4 < n4; ++i4) {
    switch (s4[i4]) {
      case ".":
        i0 = i1 = i4;
        break;
...
function formatPrefixAuto_default(x5, p4) {
  ...
  return i4 === n4 ? coefficient : i4 > n4 ? coefficient + new Array(i4 - n4 + 1).join("0") : i4 > 0 ? coefficient.slice(0, i4) + "." + coefficient.slice(i4) : "0." + new Array(1 - i4).join("0") + formatDecimalParts(x5, Math.max(0, p4 + i4 - 1))[0];
}
...
function locale_default(locale3) {
  ...
  function newFormat(specifier) {
    ...
    function format2(value) {
      var valuePrefix = prefix2, valueSuffix = suffix, i4, n4, c9;
      if (type === "c") {
...
timeYear.every = (k5) => {
  return !isFinite(k5 = Math.floor(k5)) || !(k5 > 0) ? null : timeInterval((date) => {
...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop2, count2) {
    ...
    const i4 = bisector(([, , step2]) => step2).right(tickIntervals, target);
    if (i4 === tickIntervals.length) return year2.every(tickStep(start2 / durationYear, stop2 / durationYear, count2));
    if (i4 === 0) return millisecond.every(Math.max(tickStep(start2, stop2, count2), 1));
...
function formatLocale(locale3) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      var string = [], i4 = -1, j4 = 0, n4 = specifier.length, c9, pad2, format2;
      if (!(date instanceof Date)) date = /* @__PURE__ */ new Date(+date);
      while (++i4 < n4) {
        if (specifier.charCodeAt(i4) === 37) {
          string.push(specifier.slice(j4, i4));
          if ((pad2 = pads[c9 = specifier.charAt(++i4)]) != null) c9 = specifier.charAt(++i4);
          else pad2 = c9 === "e" ? " " : "0";
  ...
  function newParse(specifier, Z2) {
    return function(string) {
      var d3 = newDate(1900, void 0, 1), i4 = parseSpecifier(d3, specifier, string += "", 0), week, day2;
      if (i4 != string.length) return null;
  ...
  function parseSpecifier(d3, specifier, string, j4) {
    var i4 = 0, n4 = specifier.length, m4 = string.length, c9, parse;
    while (i4 < n4) {
      if (j4 >= m4) return -1;
      ...
      if (c9 === 37) {
        ...
        if (!parse || (j4 = parse(d3, string, j4)) < 0) return -1;
      } else if (c9 != string.charCodeAt(j4++)) {
        return -1;
      }
    }
    return j4;
...
function ramp(range2) {
  var n4 = range2.length;
  return function(t7) {
    return range2[Math.max(0, Math.min(n4 - 1, Math.floor(t7 * n4)))];
  };
}
...
var Path = class {
  ...
  arcTo(x1, y1, x22, y22, r4) {
    ...
    else if (!(Math.abs(y01 * x21 - y21 * x01) > epsilon3) || !r4) {
      this._append`L${this._x1 = x1},${this._y1 = y1}`;
    } else {
      let x20 = x22 - x0, y20 = y22 - y0, l21_2 = x21 * x21 + y21 * y21, l20_2 = x20 * x20 + y20 * y20, l21 = Math.sqrt(l21_2), l01 = Math.sqrt(l01_2), l3 = r4 * Math.tan((pi2 - Math.acos((l21_2 + l01_2 - l20_2) / (2 * l21 * l01))) / 2), t01 = l3 / l01, t21 = l3 / l21;
  ...
  arc(x5, y4, r4, a0, a1, ccw) {
    x5 = +x5, y4 = +y4, r4 = +r4, ccw = !!ccw;
    if (r4 < 0) throw new Error(`negative radius: ${r4}`);
    let dx = r4 * Math.cos(a0), dy = r4 * Math.sin(a0), x0 = x5 + dx, y0 = y4 + dy, cw = 1 ^ ccw, da = ccw ? a0 - a1 : a1 - a0;
    if (this._x1 === null) {
    ...
    if (da > tauEpsilon) {
      this._append`A${r4},${r4},0,1,${cw},${x5 - dx},${y4 - dy}A${r4},${r4},0,1,${cw},${this._x1 = x0},${this._y1 = y0}`;
    } else if (da > epsilon3) {
      this._append`A${r4},${r4},0,${+(da >= pi2)},${cw},${this._x1 = x5 + r4 * Math.cos(a1)},${this._y1 = y4 + r4 * Math.sin(a1)}`;
    }
  }
  rect(x5, y4, w4, h3) {
    this._append`M${this._x0 = this._x1 = +x5},${this._y0 = this._y1 = +y4}h${w4 = +w4}v${+h3}h${-w4}Z`;
  }
  toString() {
    return this._;
  }
...
function cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
  var x01 = x0 - x1, y01 = y0 - y1, lo = (cw ? rc : -rc) / sqrt2(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x0 + ox, y11 = y0 + oy, x10 = x1 + ox, y10 = y1 + oy, x00 = (x11 + x10) / 2, y00 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d22 = dx * dx + dy * dy, r4 = r1 - rc, D3 = x11 * y10 - x10 * y11, d3 = (dy < 0 ? -1 : 1) * sqrt2(max2(0, r4 * r4 * d22 - D3 * D3)), cx0 = (D3 * dy - dx * d3) / d22, cy0 = (-D3 * dx - dy * d3) / d22, cx1 = (D3 * dy + dx * d3) / d22, cy1 = (-D3 * dx + dy * d3) / d22, dx0 = cx0 - x00, dy0 = cy0 - y00, dx1 = cx1 - x00, dy1 = cy1 - y00;
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon)) context.moveTo(0, 0);
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da, da1 = da, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon && (padRadius ? +padRadius.apply(this, arguments) : sqrt2(r0 * r0 + r1 * r1)), rc = min2(abs(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t04, t14;
      if (rp > epsilon) {
  ...
  arc.centroid = function() {
    var r4 = (+innerRadius.apply(this, arguments) + +outerRadius.apply(this, arguments)) / 2, a4 = (+startAngle.apply(this, arguments) + +endAngle.apply(this, arguments)) / 2 - pi / 2;
...
function line_default(x5, y4) {
  ...
  x5 = typeof x5 === "function" ? x5 : x5 === void 0 ? x2 : constant_default2(x5);
  y4 = typeof y4 === "function" ? y4 : y4 === void 0 ? y2 : constant_default2(y4);
  function line(data) {
    var i4, n4 = (data = array_default2(data)).length, d3, defined0 = false, buffer;
  ...
  line.x = function(_2) {
    return arguments.length ? (x5 = typeof _2 === "function" ? _2 : constant_default2(+_2), line) : x5;
  };
  line.y = function(_2) {
    return arguments.length ? (y4 = typeof _2 === "function" ? _2 : constant_default2(+_2), line) : y4;
  };
...
function pie_default() {
  ...
  function pie(data) {
    var i4, n4 = (data = array_default2(data)).length, j4, k5, sum3 = 0, index2 = new Array(n4), arcs = new Array(n4), a0 = +startAngle.apply(this, arguments), da = Math.min(tau, Math.max(-tau, endAngle.apply(this, arguments) - a0)), a1, p4 = Math.min(Math.abs(da) / n4, padAngle.apply(this, arguments)), pa = p4 * (da < 0 ? -1 : 1), v5;
    for (i4 = 0; i4 < n4; ++i4) {
      if ((v5 = arcs[index2[i4] = i4] = +value(data[i4], i4, data)) > 0) {
        sum3 += v5;
      }
    }
    if (sortValues != null) index2.sort(function(i5, j5) {
      return sortValues(arcs[i5], arcs[j5]);
    });
    else if (sort2 != null) index2.sort(function(i5, j5) {
...
Bundle.prototype = {
  ...
  lineEnd: function() {
    var x5 = this._x, y4 = this._y, j4 = x5.length - 1;
    if (j4 > 0) {
      var x0 = x5[0], y0 = y4[0], dx = x5[j4] - x0, dy = y4[j4] - y0, i4 = -1, t7;
      while (++i4 <= j4) {
        t7 = i4 / j4;
        this._basis.point(
          this._beta * x5[i4] + (1 - this._beta) * (x0 + t7 * dx),
...
function controlPoints(x5) {
  var i4, n4 = x5.length - 1, m4, a4 = new Array(n4), b4 = new Array(n4), r4 = new Array(n4);
  a4[0] = 0, b4[0] = 2, r4[0] = x5[0] + 2 * x5[1];
  for (i4 = 1; i4 < n4 - 1; ++i4) a4[i4] = 1, b4[i4] = 4, r4[i4] = 4 * x5[i4] + 2 * x5[i4 + 1];
  a4[n4 - 1] = 2, b4[n4 - 1] = 7, r4[n4 - 1] = 8 * x5[n4 - 1] + x5[n4];
  for (i4 = 1; i4 < n4; ++i4) m4 = a4[i4] / b4[i4 - 1], b4[i4] -= m4, r4[i4] -= m4 * r4[i4 - 1];
  a4[n4 - 1] = r4[n4 - 1] / b4[n4 - 1];
  for (i4 = n4 - 2; i4 >= 0; --i4) a4[i4] = (r4[i4] - a4[i4 + 1]) / b4[i4];
  b4[n4 - 1] = (x5[n4] + a4[n4 - 1]) / 2;
  for (i4 = 0; i4 < n4 - 1; ++i4) b4[i4] = 2 * x5[i4 + 1] - a4[i4 + 1];
  return [a4, b4];
}
...
function expand_default(series, order) {
  ...
  for (var i4, n4, j4 = 0, m4 = series[0].length, y4; j4 < m4; ++j4) {
    for (y4 = i4 = 0; i4 < n4; ++i4) y4 += series[i4][j4][1] || 0;
    if (y4) for (i4 = 0; i4 < n4; ++i4) series[i4][j4][1] /= y4;
  }
...
function diverging_default(series, order) {
  if (!((n4 = series.length) > 0)) return;
  for (var i4, j4 = 0, d3, dy, yp, yn2, n4, m4 = series[order[0]].length; j4 < m4; ++j4) {
    for (yp = yn2 = 0, i4 = 0; i4 < n4; ++i4) {
...
function silhouette_default(series, order) {
  ...
  for (var j4 = 0, s0 = series[order[0]], n4, m4 = s0.length; j4 < m4; ++j4) {
    for (var i4 = 0, y4 = 0; i4 < n4; ++i4) y4 += series[i4][j4][1] || 0;
...
function peak(series) {
  var i4 = -1, j4 = 0, n4 = series.length, vi, vj = -Infinity;
  while (++i4 < n4) if ((vi = +series[i4][1]) > vj) vj = vi, j4 = i4;
  return j4;
}
...
function sum2(series) {
  ...
  while (++i4 < n4) if (v5 = +series[i4][1]) s4 += v5;
  return s4;
}
...
function jr() {
  return jr = Object.assign ? Object.assign.bind() : function(e7) {
    for (var r4 = 1; r4 < arguments.length; r4++) {
      var t7 = arguments[r4];
      for (var n4 in t7) Object.prototype.hasOwnProperty.call(t7, n4) && (e7[n4] = t7[n4]);
    }
    return e7;
...
function Br(e7, r4) {
  if (null == e7) return {};
  var t7, n4, i4 = {}, o4 = Object.keys(e7);
  for (n4 = 0; n4 < o4.length; n4++) t7 = o4[n4], r4.indexOf(t7) >= 0 || (i4[t7] = e7[t7]);
  return i4;
}
...
var Lr = function(e7, r4) {
  return jr({}, r4, e7);
};
var Ir = function(e7, r4) {
  var t7 = (0, import_merge2.default)({}, e7, r4);
  return Gr.forEach(function(e8) {
    (0, import_set.default)(t7, e8, Lr((0, import_get.default)(t7, e8), t7.text));
  }), t7;
};
var Yr = (0, import_react16.createContext)();
var Ar = function(e7) {
  var t7 = e7.children, n4 = e7.animate, i4 = void 0 === n4 || n4, o4 = e7.config, l3 = void 0 === o4 ? "default" : o4, a4 = (0, import_react16.useMemo)(function() {
    var e8 = (0, import_isString.default)(l3) ? config[l3] : l3;
    return { animate: i4, config: e8 };
  }, [i4, l3]);
  return (0, import_jsx_runtime2.jsx)(Yr.Provider, { value: a4, children: t7 });
};
...
var wt = function(e7, t7, n4) {
  return void 0 === n4 && (n4 = {}), (0, import_react16.useMemo)(function() {
    var r4 = jr({}, _t, n4);
    return { margin: r4, innerWidth: e7 - r4.left - r4.right, innerHeight: t7 - r4.top - r4.bottom, outerWidth: e7, outerHeight: t7 };
  }, [e7, t7, n4.top, n4.right, n4.bottom, n4.left]);
};
var kt = function() {
  var e7 = (0, import_react16.useRef)(null), r4 = (0, import_react16.useState)({ left: 0, top: 0, width: 0, height: 0 }), t7 = r4[0], l3 = r4[1], a4 = (0, import_react16.useState)(function() {
    return "undefined" == typeof ResizeObserver ? null : new ResizeObserver(function(e8) {
      var r5 = e8[0];
      return l3(r5.contentRect);
    });
  })[0];
  return (0, import_react16.useEffect)(function() {
    return e7.current && null !== a4 && a4.observe(e7.current), function() {
...
var Ct = {};
var Wt = function(e7) {
  var r4 = e7.theme, t7 = void 0 === r4 ? Ct : r4, n4 = e7.children, i4 = Rt(t7);
  return (0, import_jsx_runtime2.jsx)(qt.Provider, { value: i4, children: n4 });
};
...
var Pt = function(e7) {
  var r4 = e7.children, t7 = e7.condition, n4 = e7.wrapper;
  return t7 ? (0, import_react16.cloneElement)(n4, {}, r4) : r4;
};
...
var St = function(e7) {
  var r4 = e7.children, t7 = e7.theme, i4 = e7.renderWrapper, o4 = void 0 === i4 || i4, l3 = e7.isInteractive, a4 = void 0 === l3 || l3, d3 = e7.animate, s4 = e7.motionConfig, u3 = (0, import_react16.useRef)(null);
  return (0, import_jsx_runtime2.jsx)(Wt, { theme: t7, children: (0, import_jsx_runtime2.jsx)(Ar, { animate: d3, config: s4, children: (0, import_jsx_runtime2.jsx)(M, { container: u3, children: (0, import_jsx_runtime2.jsxs)(Pt, { condition: o4, wrapper: (0, import_jsx_runtime2.jsx)("div", { style: jt, ref: u3 }), children: [r4, a4 && (0, import_jsx_runtime2.jsx)(F, {})] }) }) }) });
};
...
var Lt = function(e7) {
  var t7 = e7.children, i4 = e7.theme, o4 = e7.isInteractive, l3 = void 0 === o4 || o4, d3 = e7.renderWrapper, s4 = void 0 === d3 || d3, u3 = e7.animate, c9 = e7.motionConfig, f3 = (0, import_react16.useRef)(null), m4 = V(f3), y4 = m4.actions, v5 = m4.state, _2 = (0, import_react16.useCallback)(function(e8, r4) {
    return y4.showTooltipFromEvent(e8, r4);
  }, [y4.showTooltipFromEvent]), w4 = (0, import_react16.useMemo)(function() {
    return { showTooltip: l3 ? _2 : Bt, hideTooltip: l3 ? y4.hideTooltip : Bt };
  }, [y4.hideTooltip, l3, _2]);
  return (0, import_jsx_runtime2.jsx)(Wt, { theme: i4, children: (0, import_jsx_runtime2.jsx)(Ar, { animate: u3, config: c9, children: (0, import_jsx_runtime2.jsx)(j.Provider, { value: y4, children: (0, import_jsx_runtime2.jsx)(O.Provider, { value: v5, children: (0, import_jsx_runtime2.jsxs)(Pt, { condition: s4, wrapper: (0, import_jsx_runtime2.jsx)("div", { style: Gt, ref: f3 }), children: [t7(w4), l3 && (0, import_jsx_runtime2.jsx)(F, {})] }) }) }) }) });
};
...
var It = function(e7) {
  var r4 = e7.children, t7 = kt(), n4 = t7[0], i4 = t7[1], o4 = i4.width > 0 && i4.height > 0;
  return (0, import_jsx_runtime2.jsx)("div", { ref: n4, style: { width: "100%", height: "100%" }, children: o4 && r4({ width: i4.width, height: i4.height }) });
};
It.propTypes = { children: import_prop_types.default.func.isRequired };
var Yt = ["id", "colors"];
var Dt = function(e7) {
  var r4 = e7.id, t7 = e7.colors, n4 = Br(e7, Yt);
  return (0, import_jsx_runtime2.jsx)("linearGradient", jr({ id: r4, x1: 0, x2: 0, y1: 0, y2: 1 }, n4, { children: t7.map(function(e8) {
    var r5 = e8.offset, t8 = e8.color, n5 = e8.opacity;
    return (0, import_jsx_runtime2.jsx)("stop", { offset: r5 + "%", stopColor: t8, stopOpacity: void 0 !== n5 ? n5 : 1 }, r5);
  }) }));
};
...
var Ft = (0, import_react16.memo)(function(e7) {
  var r4 = e7.id, t7 = e7.background, n4 = void 0 === t7 ? Ut.background : t7, i4 = e7.color, o4 = void 0 === i4 ? Ut.color : i4, l3 = e7.size, a4 = void 0 === l3 ? Ut.size : l3, d3 = e7.padding, s4 = void 0 === d3 ? Ut.padding : d3, u3 = e7.stagger, c9 = void 0 === u3 ? Ut.stagger : u3, f3 = a4 + s4, p4 = a4 / 2, h3 = s4 / 2;
  return true === c9 && (f3 = 2 * a4 + 2 * s4), (0, import_jsx_runtime2.jsxs)("pattern", { id: r4, width: f3, height: f3, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: f3, height: f3, fill: n4 }), (0, import_jsx_runtime2.jsx)("circle", { cx: h3 + p4, cy: h3 + p4, r: p4, fill: o4 }), c9 && (0, import_jsx_runtime2.jsx)("circle", { cx: 1.5 * s4 + a4 + p4, cy: 1.5 * s4 + a4 + p4, r: p4, fill: o4 })] });
});
...
var on = (0, import_react16.memo)(function(e7) {
  var r4 = e7.id, t7 = e7.spacing, n4 = void 0 === t7 ? nn.spacing : t7, i4 = e7.rotation, o4 = void 0 === i4 ? nn.rotation : i4, l3 = e7.background, a4 = void 0 === l3 ? nn.background : l3, d3 = e7.color, s4 = void 0 === d3 ? nn.color : d3, u3 = e7.lineWidth, c9 = void 0 === u3 ? nn.lineWidth : u3, f3 = Math.round(o4) % 360, p4 = Math.abs(n4);
  f3 > 180 ? f3 -= 360 : f3 > 90 ? f3 -= 180 : f3 < -180 ? f3 += 360 : f3 < -90 && (f3 += 180);
  var h3, g3 = p4, b4 = p4;
  return 0 === f3 ? h3 = "\n                M 0 0 L " + g3 + " 0\n                M 0 " + b4 + " L " + g3 + " " + b4 + "\n            " : 90 === f3 ? h3 = "\n                M 0 0 L 0 " + b4 + "\n                M " + g3 + " 0 L " + g3 + " " + b4 + "\n            " : (g3 = Math.abs(p4 / Math.sin(Ht(f3))), b4 = p4 / Math.sin(Ht(90 - f3)), h3 = f3 > 0 ? "\n                    M 0 " + -b4 + " L " + 2 * g3 + " " + b4 + "\n                    M " + -g3 + " " + -b4 + " L " + g3 + " " + b4 + "\n                    M " + -g3 + " 0 L " + g3 + " " + 2 * b4 + "\n                " : "\n                    M " + -g3 + " " + b4 + " L " + g3 + " " + -b4 + "\n                    M " + -g3 + " " + 2 * b4 + " L " + 2 * g3 + " " + -b4 + "\n                    M 0 " + 2 * b4 + " L " + 2 * g3 + " 0\n                "), (0, import_jsx_runtime2.jsxs)("pattern", { id: r4, width: g3, height: b4, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: g3, height: b4, fill: a4, stroke: "rgba(255, 0, 0, 0.1)", strokeWidth: 0 }), (0, import_jsx_runtime2.jsx)("path", { d: h3, strokeWidth: c9, stroke: s4, strokeLinecap: "square" })] });
});
...
var dn = (0, import_react16.memo)(function(e7) {
  var r4 = e7.id, t7 = e7.color, n4 = void 0 === t7 ? an.color : t7, i4 = e7.background, o4 = void 0 === i4 ? an.background : i4, l3 = e7.size, a4 = void 0 === l3 ? an.size : l3, d3 = e7.padding, s4 = void 0 === d3 ? an.padding : d3, u3 = e7.stagger, c9 = void 0 === u3 ? an.stagger : u3, f3 = a4 + s4, p4 = s4 / 2;
  return true === c9 && (f3 = 2 * a4 + 2 * s4), (0, import_jsx_runtime2.jsxs)("pattern", { id: r4, width: f3, height: f3, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: f3, height: f3, fill: o4 }), (0, import_jsx_runtime2.jsx)("rect", { x: p4, y: p4, width: a4, height: a4, fill: n4 }), c9 && (0, import_jsx_runtime2.jsx)("rect", { x: 1.5 * s4 + a4, y: 1.5 * s4 + a4, width: a4, height: a4, fill: n4 })] });
});
...
var pn = function(e7) {
  ...
  return !r4 || r4.length < 1 ? null : (0, import_jsx_runtime2.jsx)("defs", { "aria-hidden": true, children: r4.map(function(e8) {
    var r5 = e8.type, t7 = Br(e8, cn);
    return fn[r5] ? (0, import_react16.createElement)(fn[r5], jr({ key: t7.id }, t7)) : null;
  }) });
};
...
var gn = function(e7) {
  var r4 = e7.width, t7 = e7.height, n4 = e7.margin, i4 = e7.defs, o4 = e7.children, l3 = e7.role, a4 = e7.ariaLabel, d3 = e7.ariaLabelledBy, s4 = e7.ariaDescribedBy, u3 = e7.isFocusable, c9 = zt();
  return (0, import_jsx_runtime2.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: r4, height: t7, role: l3, "aria-label": a4, "aria-labelledby": d3, "aria-describedby": s4, focusable: u3, tabIndex: u3 ? 0 : void 0, children: [(0, import_jsx_runtime2.jsx)(hn, { defs: i4 }), (0, import_jsx_runtime2.jsx)("rect", { width: r4, height: t7, fill: c9.background }), (0, import_jsx_runtime2.jsx)("g", { transform: "translate(" + n4.left + "," + n4.top + ")", children: o4 })] });
};
...
var bn = function(e7) {
  var r4 = e7.size, t7 = e7.color, n4 = e7.borderWidth, i4 = e7.borderColor;
  return (0, import_jsx_runtime2.jsx)("circle", { r: r4 / 2, fill: t7, stroke: i4, strokeWidth: n4, style: { pointerEvents: "none" } });
};
...
var yn = function(e7) {
  var r4 = e7.x, t7 = e7.y, n4 = e7.symbol, i4 = void 0 === n4 ? mn : n4, o4 = e7.size, l3 = e7.datum, a4 = e7.color, d3 = e7.borderWidth, u3 = e7.borderColor, c9 = e7.label, f3 = e7.labelTextAnchor, p4 = void 0 === f3 ? "middle" : f3, h3 = e7.labelYOffset, g3 = void 0 === h3 ? -12 : h3, b4 = zt(), m4 = Ur(), y4 = m4.animate, v5 = m4.config, _2 = useSpring({ transform: "translate(" + r4 + ", " + t7 + ")", config: v5, immediate: !y4 });
  return (0, import_jsx_runtime2.jsxs)(animated.g, { transform: _2.transform, style: { pointerEvents: "none" }, children: [(0, import_react16.createElement)(i4, { size: o4, color: a4, datum: l3, borderWidth: d3, borderColor: u3 }), c9 && (0, import_jsx_runtime2.jsx)("text", { textAnchor: p4, y: g3, style: Mt(b4.dots.text), children: c9 })] });
};
...
var _n = function(e7) {
  var r4 = e7.width, t7 = e7.height, n4 = e7.axis, i4 = e7.scale, o4 = e7.value, l3 = e7.lineStyle, a4 = e7.textStyle, d3 = e7.legend, s4 = e7.legendNode, u3 = e7.legendPosition, c9 = void 0 === u3 ? "top-right" : u3, f3 = e7.legendOffsetX, p4 = void 0 === f3 ? 14 : f3, h3 = e7.legendOffsetY, g3 = void 0 === h3 ? 14 : h3, b4 = e7.legendOrientation, m4 = void 0 === b4 ? "horizontal" : b4, y4 = zt(), v5 = 0, _2 = 0, w4 = 0, k5 = 0;
  if ("y" === n4 ? (w4 = i4(o4), _2 = r4) : (v5 = i4(o4), k5 = t7), d3 && !s4) {
    var R = function(e8) {
      var r5 = e8.axis, t8 = e8.width, n5 = e8.height, i5 = e8.position, o5 = e8.offsetX, l4 = e8.offsetY, a5 = e8.orientation, d4 = 0, s5 = 0, u4 = "vertical" === a5 ? -90 : 0, c10 = "start";
      if ("x" === r5) switch (i5) {
        case "top-left":
          d4 = -o5, s5 = l4, c10 = "end";
          break;
        case "top":
          s5 = -l4, c10 = "horizontal" === a5 ? "middle" : "start";
          break;
        case "top-right":
          d4 = o5, s5 = l4, c10 = "horizontal" === a5 ? "start" : "end";
          break;
        case "right":
          d4 = o5, s5 = n5 / 2, c10 = "horizontal" === a5 ? "start" : "middle";
          break;
        case "bottom-right":
          d4 = o5, s5 = n5 - l4, c10 = "start";
          break;
        case "bottom":
          s5 = n5 + l4, c10 = "horizontal" === a5 ? "middle" : "end";
          break;
        case "bottom-left":
          s5 = n5 - l4, d4 = -o5, c10 = "horizontal" === a5 ? "end" : "start";
          break;
        case "left":
          d4 = -o5, s5 = n5 / 2, c10 = "horizontal" === a5 ? "end" : "middle";
      }
      else switch (i5) {
        case "top-left":
          ...
          break;
        case "top":
          d4 = t8 / 2, s5 = -l4, c10 = "horizontal" === a5 ? "middle" : "start";
          break;
        case "top-right":
          d4 = t8 - o5, s5 = -l4, c10 = "horizontal" === a5 ? "end" : "start";
          break;
        case "right":
          d4 = t8 + o5, c10 = "horizontal" === a5 ? "start" : "middle";
          break;
        case "bottom-right":
          d4 = t8 - o5, s5 = l4, c10 = "end";
          break;
        case "bottom":
          d4 = t8 / 2, s5 = l4, c10 = "horizontal" === a5 ? "middle" : "end";
          break;
        case "bottom-left":
          d4 = o5, s5 = l4, c10 = "horizontal" === a5 ? "start" : "end";
          break;
        case "left":
          d4 = -o5, c10 = "horizontal" === a5 ? "end" : "middle";
      }
      return { x: d4, y: s5, rotation: u4, textAnchor: c10 };
    }({ axis: n4, width: r4, height: t7, position: c9, offsetX: p4, offsetY: g3, orientation: m4 });
  ...
  return (0, import_jsx_runtime2.jsxs)("g", { transform: "translate(" + v5 + ", " + w4 + ")", children: [(0, import_jsx_runtime2.jsx)("line", { x1: 0, x2: _2, y1: 0, y2: k5, stroke: y4.markers.lineColor, strokeWidth: y4.markers.lineStrokeWidth, style: l3 }), s4] });
};
...
var kn = function(e7) {
  var r4 = e7.markers, t7 = e7.width, n4 = e7.height, i4 = e7.xScale, o4 = e7.yScale;
  return r4 && 0 !== r4.length ? r4.map(function(e8, r5) {
    return (0, import_jsx_runtime2.jsx)(wn, jr({}, e8, { width: t7, height: n4, scale: "y" === e8.axis ? o4 : i4 }), r5);
  }) : null;
};
...
var Mn = function(e7, r4, t7, n4) {
  var i4 = t7 - e7, o4 = n4 - r4;
  return i4 *= i4, o4 *= o4, Math.sqrt(i4 + o4);
};
var Pn = function(e7, r4, t7, n4) {
  var i4 = Math.atan2(n4 - r4, t7 - e7) - Math.PI / 2;
  return i4 > 0 ? i4 : 2 * Math.PI + i4;
};
var Sn = function(e7, r4) {
  var t7, n4 = "touches" in r4 ? r4.touches[0] : r4, i4 = n4.clientX, o4 = n4.clientY, l3 = e7.getBoundingClientRect(), a4 = (t7 = void 0 !== e7.getBBox ? e7.getBBox() : { width: e7.offsetWidth || 0, height: e7.offsetHeight || 0 }).width === l3.width ? 1 : t7.width / l3.width;
  return [(i4 - l3.left) * a4, (o4 - l3.top) * a4];
};
var Bn = Object.keys(Et);
var Gn = Object.keys(un);
var Ln = function(e7, r4, t7) {
  if ("*" === e7) return true;
  if ((0, import_isFunction.default)(e7)) return e7(r4);
  if ((0, import_isPlainObject.default)(e7)) {
    var n4 = t7 ? (0, import_get.default)(r4, t7) : r4;
    return (0, import_isEqual.default)((0, import_pick.default)(n4, Object.keys(e7)), e7);
  }
  return false;
};
var In = function(e7, r4, t7, n4) {
  var i4 = void 0 === n4 ? {} : n4, o4 = i4.dataKey, l3 = i4.colorKey, a4 = void 0 === l3 ? "color" : l3, d3 = i4.targetKey, s4 = void 0 === d3 ? "fill" : d3, u3 = [], c9 = {};
  return e7.length && r4.length && (u3 = [].concat(e7), r4.forEach(function(r5) {
    for (var n5 = function() {
      var n6 = t7[i5], l4 = n6.id, d4 = n6.match;
      if (Ln(d4, r5, o4)) {
        ...
        if (f3) {
          if (Gn.includes(f3.type)) if ("inherit" === f3.background || "inherit" === f3.color) {
            var p4 = (0, import_get.default)(r5, a4), h3 = f3.background, g3 = f3.color, b4 = l4;
            "inherit" === f3.background && (b4 = b4 + ".bg." + p4, h3 = p4), "inherit" === f3.color && (b4 = b4 + ".fg." + p4, g3 = p4), (0, import_set.default)(r5, s4, "url(#" + b4 + ")"), c9[b4] || (u3.push(jr({}, f3, { id: b4, background: h3, color: g3 })), c9[b4] = 1);
          } else (0, import_set.default)(r5, s4, "url(#" + l4 + ")");
          else if (Bn.includes(f3.type)) {
            if (f3.colors.map(function(e8) {
              return e8.color;
            }).includes("inherit")) {
              var m4 = (0, import_get.default)(r5, a4), _2 = l4, w4 = jr({}, f3, { colors: f3.colors.map(function(e8, r6) {
                return "inherit" !== e8.color ? e8 : (_2 = _2 + "." + r6 + "." + m4, jr({}, e8, { color: "inherit" === e8.color ? m4 : e8.color }));
              }) });
              w4.id = _2, (0, import_set.default)(r5, s4, "url(#" + _2 + ")"), c9[_2] || (u3.push(w4), c9[_2] = 1);
            } else (0, import_set.default)(r5, s4, "url(#" + l4 + ")");
          }
        }
        return "break";
      }
    }, i5 = 0; i5 < t7.length; i5++) {
      if ("break" === n5()) break;
    }
  })), u3;
};
...
function qe() {
  return qe = Object.assign ? Object.assign.bind() : function(e7) {
    for (var r4 = 1; r4 < arguments.length; r4++) {
      var n4 = arguments[r4];
      for (var t7 in n4) Object.prototype.hasOwnProperty.call(n4, t7) && (e7[t7] = n4[t7]);
    }
    return e7;
...
function Ce(e7, r4) {
  ...
  for (var n4 = 0, t7 = new Array(r4); n4 < r4; n4++) t7[n4] = e7[n4];
  return t7;
}
function Ge(e7, r4) {
  var n4 = "undefined" != typeof Symbol && e7[Symbol.iterator] || e7["@@iterator"];
  if (n4) return (n4 = n4.call(e7)).next.bind(n4);
  if (Array.isArray(e7) || (n4 = function(e8, r5) {
    if (e8) {
      if ("string" == typeof e8) return Ce(e8, r5);
      var n5 = Object.prototype.toString.call(e8).slice(8, -1);
      return "Object" === n5 && e8.constructor && (n5 = e8.constructor.name), "Map" === n5 || "Set" === n5 ? Array.from(e8) : "Arguments" === n5 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n5) ? Ce(e8, r5) : void 0;
    }
...
var We = function(e7, r4) {
  ...
  if ((0, import_isPlainObject2.default)(e7)) {
    if (function(e8) {
      ...
      if (void 0 === n4) throw new Error("Color from theme is undefined at path: '" + e7.theme + "'");
      return function() {
        return n4;
      };
    }
    if (function(e8) {
      ...
      if (Array.isArray(e7.modifiers)) {
        for (var o4, i4 = [], u3 = function() {
          ...
          if ("brighter" === r5) i4.push(function(e9) {
            return e9.brighter(n5);
          });
          else if ("darker" === r5) i4.push(function(e9) {
            return e9.darker(n5);
          });
          else {
        ...
        }, a4 = Ge(e7.modifiers); !(o4 = a4()).done; ) u3();
...
var fr = function(e7, r4) {
  ...
  if ((0, import_isPlainObject2.default)(e7)) {
    ...
    if (function(e8) {
      ...
      if (He(e7.scheme)) {
        var i4 = ordinal(Be[e7.scheme]), u3 = function(e8) {
          return i4(n4(e8));
        };
      ...
      if (Je(e7.scheme)) {
        ...
        var a4 = ordinal(Be[e7.scheme][e7.size || 11]), l3 = function(e8) {
          return a4(n4(e8));
        };
      ...
      if (Ke(e7.scheme)) {
        ...
        var c9 = ordinal(Be[e7.scheme][e7.size || 9]), s4 = function(e8) {
          return c9(n4(e8));
        };
...
function M2() {
  return M2 = Object.assign ? Object.assign.bind() : function(t7) {
    for (var n4 = 1; n4 < arguments.length; n4++) {
      var e7 = arguments[n4];
      for (var r4 in e7) Object.prototype.hasOwnProperty.call(e7, r4) && (t7[r4] = e7[r4]);
    }
    return t7;
...
var b2 = function(n4) {
  var e7 = n4.label, r4 = n4.style, a4 = zt();
  return (0, import_jsx_runtime3.jsx)(animated.g, { transform: r4.transform, opacity: r4.progress, style: k3, children: (0, import_jsx_runtime3.jsx)(animated.text, { textAnchor: "middle", dominantBaseline: "central", style: M2({}, a4.labels.text, { fill: r4.textColor }), children: e7 }) });
};
var C4 = function(t7) {
  var n4 = t7 % (2 * Math.PI);
...
var L = function(t7, n4) {
  return t7.filter(function(t8) {
    return Math.abs(Kt(t8.arc.endAngle - t8.arc.startAngle)) >= n4;
  });
};
var E3 = { startAngle: { enter: function(t7) {
...
var T2 = function(t7, n4) {
  var e7 = Vt(t7) - Math.PI / 2, r4 = t7.innerRadius + (t7.outerRadius - t7.innerRadius) * n4;
  return Jt(e7, r4);
};
var j2 = function(t7) {
  return function(e7, r4, i4, a4) {
    return to2([e7, r4, i4, a4], function(n4, e8, r5, i5) {
      var a5 = T2({ startAngle: n4, endAngle: e8, innerRadius: r5, outerRadius: i5 }, t7);
...
var W2 = function(t7, n4, r4, i4) {
  ...
  var a4 = Ur(), o4 = a4.animate, u3 = a4.config, l3 = I(r4, i4);
...
var S = function(t7) {
  var n4 = t7.data, e7 = t7.offset, r4 = void 0 === e7 ? 0.5 : e7, i4 = t7.skipAngle, a4 = void 0 === i4 ? 0 : i4, o4 = t7.computeExtraProps, u3 = void 0 === o4 ? function() {
    return {};
  } : o4;
  return (0, import_react18.useMemo)(function() {
    return L(n4, a4).map(function(t8) {
      var n5 = T2(t8.arc, r4);
...
var B2 = function(t7) {
  var n4 = t7.center, e7 = t7.data, r4 = t7.transitionMode, o4 = t7.label, u3 = t7.radiusOffset, l3 = t7.skipAngle, s4 = t7.textColor, f3 = t7.component, c9 = void 0 === f3 ? b2 : f3, g3 = Wn(o4), h3 = zt(), x5 = Xe(s4, h3), m4 = (0, import_react18.useMemo)(function() {
    return e7.filter(function(t8) {
      return Math.abs(Kt(t8.arc.endAngle - t8.arc.startAngle)) >= l3;
    });
  }, [e7, l3]), y4 = W2(m4, u3, r4), k5 = y4.transition, C5 = y4.interpolate, L2 = c9;
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + n4[0] + "," + n4[1] + ")", children: k5(function(t8, n5) {
    return (0, import_react18.createElement)(L2, { key: n5.id, datum: n5, label: g3(n5), style: M2({}, t8, { transform: C5(t8.startAngle, t8.endAngle, t8.innerRadius, t8.outerRadius), textColor: x5(n5) }) });
  }) });
};
...
var z3 = function(t7) {
  var n4 = t7.data, e7 = t7.offset, r4 = t7.skipAngle, a4 = t7.label, o4 = t7.textColor, u3 = Wn(a4), l3 = zt(), s4 = Xe(o4, l3), f3 = (0, import_react18.useCallback)(function(t8) {
...
var G = function(n4) {
  var e7 = n4.label, r4 = n4.style, a4 = zt();
  return (0, import_jsx_runtime3.jsxs)(animated.g, { opacity: r4.opacity, children: [(0, import_jsx_runtime3.jsx)(animated.path, { fill: "none", stroke: r4.linkColor, strokeWidth: r4.thickness, d: r4.path }), (0, import_jsx_runtime3.jsx)(animated.text, { transform: r4.textPosition, textAnchor: r4.textAnchor, dominantBaseline: "central", style: M2({}, a4.labels.text, { fill: r4.textColor }), children: e7 })] });
};
var q2 = function(t7) {
  var n4 = C4(t7.startAngle + (t7.endAngle - t7.startAngle) / 2 - Math.PI / 2);
  return n4 < Math.PI / 2 || n4 > 1.5 * Math.PI ? "start" : "end";
};
var D2 = function(t7, n4, e7, r4) {
  var i4, a4, u3 = C4(t7.startAngle + (t7.endAngle - t7.startAngle) / 2 - Math.PI / 2), l3 = Jt(u3, t7.outerRadius + n4), s4 = Jt(u3, t7.outerRadius + n4 + e7);
  return u3 < Math.PI / 2 || u3 > 1.5 * Math.PI ? (i4 = "after", a4 = { x: s4.x + r4, y: s4.y }) : (i4 = "before", a4 = { x: s4.x - r4, y: s4.y }), { side: i4, points: [l3, s4, a4] };
};
...
var J = function(t7, e7, r4, i4, a4, o4, u3) {
  return to2([t7, e7, r4, i4, a4, o4, u3], function(t8, n4, e8, r5, i5, a5, o5) {
    var u4 = D2({ startAngle: t8, endAngle: n4, innerRadius: e8, outerRadius: r5 }, i5, a5, o5).points;
    return H(u4);
  });
};
var K2 = function(t7, e7, r4, i4) {
  return to2([t7, e7, r4, i4], function(t8, n4, e8, r5) {
    return q2({ startAngle: t8, endAngle: n4, innerRadius: e8, outerRadius: r5 });
  });
};
var N2 = function(t7, e7, r4, i4, a4, o4, u3, l3) {
  return to2([t7, e7, r4, i4, a4, o4, u3, l3], function(t8, n4, e8, r5, i5, a5, o5, u4) {
    var l4 = D2({ startAngle: t8, endAngle: n4, innerRadius: e8, outerRadius: r5 }, i5, a5, o5), s4 = l4.points, d3 = l4.side, f3 = s4[2];
    return "before" === d3 ? f3.x -= u4 : f3.x += u4, "translate(" + f3.x + "," + f3.y + ")";
  });
};
var Q = function(t7) {
  var n4 = t7.data, r4 = t7.offset, a4 = void 0 === r4 ? 0 : r4, o4 = t7.diagonalLength, u3 = t7.straightLength, l3 = t7.skipAngle, d3 = void 0 === l3 ? 0 : l3, f3 = t7.textOffset, c9 = t7.linkColor, g3 = t7.textColor, p4 = Ur(), h3 = p4.animate, A4 = p4.config, x5 = zt(), m4 = Xe(c9, x5), y4 = Xe(g3, x5), M3 = function(t8, n5) {
    return (0, import_react18.useMemo)(function() {
      return L(t8, n5);
    }, [t8, n5]);
  }(n4, d3), k5 = function(t8) {
    var n5 = t8.offset, e7 = t8.diagonalLength, r5 = t8.straightLength, i4 = t8.textOffset, a5 = t8.getLinkColor, o5 = t8.getTextColor;
    return (0, import_react18.useMemo)(function() {
      return { enter: function(t9) {
        return { startAngle: t9.arc.startAngle, endAngle: t9.arc.endAngle, innerRadius: t9.arc.innerRadius, outerRadius: t9.arc.outerRadius, offset: n5, diagonalLength: 0, straightLength: 0, textOffset: i4, linkColor: a5(t9), textColor: o5(t9), opacity: 0 };
      }, update: function(t9) {
        return { startAngle: t9.arc.startAngle, endAngle: t9.arc.endAngle, innerRadius: t9.arc.innerRadius, outerRadius: t9.arc.outerRadius, offset: n5, diagonalLength: e7, straightLength: r5, textOffset: i4, linkColor: a5(t9), textColor: o5(t9), opacity: 1 };
      }, leave: function(t9) {
        return { startAngle: t9.arc.startAngle, endAngle: t9.arc.endAngle, innerRadius: t9.arc.innerRadius, outerRadius: t9.arc.outerRadius, offset: n5, diagonalLength: 0, straightLength: 0, textOffset: i4, linkColor: a5(t9), textColor: o5(t9), opacity: 0 };
      } };
    }, [e7, r5, i4, a5, o5, n5]);
  }({ offset: a4, diagonalLength: o4, straightLength: u3, textOffset: f3, getLinkColor: m4, getTextColor: y4 });
  return { transition: useTransition(M3, { keys: function(t8) {
    return t8.id;
  }, initial: k5.update, from: k5.enter, enter: k5.update, update: k5.update, leave: k5.leave, config: A4, immediate: !h3 }), interpolateLink: J, interpolateTextAnchor: K2, interpolateTextPosition: N2 };
};
var U = function(t7) {
  var n4 = t7.center, e7 = t7.data, r4 = t7.label, i4 = t7.skipAngle, a4 = t7.offset, o4 = t7.diagonalLength, u3 = t7.straightLength, l3 = t7.strokeWidth, s4 = t7.textOffset, f3 = t7.textColor, c9 = t7.linkColor, g3 = t7.component, h3 = void 0 === g3 ? G : g3, v5 = Wn(r4), x5 = Q({ data: e7, skipAngle: i4, offset: a4, diagonalLength: o4, straightLength: u3, textOffset: s4, linkColor: c9, textColor: f3 }), R = x5.transition, m4 = x5.interpolateLink, y4 = x5.interpolateTextAnchor, k5 = x5.interpolateTextPosition, b4 = h3;
...
var V2 = function(t7, n4, e7, r4) {
  t7.textBaseline = "middle", t7.font = e7.labels.text.fontSize + "px " + e7.labels.text.fontFamily, n4.forEach(function(n5) {
    t7.fillStyle = n5.textColor, t7.textAlign = rn.canvas.align[n5.textAnchor], t7.fillText("" + n5.label, n5.x, n5.y), t7.beginPath(), t7.strokeStyle = n5.linkColor, t7.lineWidth = r4, n5.points.forEach(function(n6, e8) {
...
var X = function(t7) {
  var n4 = t7.data, e7 = t7.skipAngle, r4 = void 0 === e7 ? 0 : e7, i4 = t7.offset, o4 = void 0 === i4 ? 0.5 : i4, u3 = t7.diagonalLength, l3 = t7.straightLength, s4 = t7.computeExtraProps, d3 = void 0 === s4 ? function() {
    ...
    return n4.filter(function(t8) {
      return Math.abs(Kt(t8.arc.endAngle - t8.arc.startAngle)) >= r4;
    }).map(function(t8) {
      return M2({}, D2(t8.arc, o4, u3, l3), { data: t8 });
    });
  }, [n4, r4, o4, u3, l3]);
  return (0, import_react18.useMemo)(function() {
...
var Y = function(t7) {
  var n4 = t7.data, e7 = t7.skipAngle, r4 = t7.offset, a4 = t7.diagonalLength, o4 = t7.straightLength, u3 = t7.textOffset, l3 = void 0 === u3 ? 0 : u3, s4 = t7.label, f3 = t7.linkColor, c9 = t7.textColor, g3 = Wn(s4), p4 = zt(), h3 = Xe(f3, p4), v5 = Xe(c9, p4), A4 = (0, import_react18.useCallback)(function(t8) {
  ...
  return X({ data: n4, skipAngle: e7, offset: r4, diagonalLength: a4, straightLength: o4, computeExtraProps: A4 });
};
var tt2 = function(n4) {
  var e7 = n4.datum, r4 = n4.style, i4 = n4.onClick, a4 = n4.onMouseEnter, o4 = n4.onMouseMove, u3 = n4.onMouseLeave, l3 = (0, import_react18.useCallback)(function(t7) {
    return null == i4 ? void 0 : i4(e7, t7);
  }, [i4, e7]), s4 = (0, import_react18.useCallback)(function(t7) {
    return null == a4 ? void 0 : a4(e7, t7);
  }, [a4, e7]), d3 = (0, import_react18.useCallback)(function(t7) {
    return null == o4 ? void 0 : o4(e7, t7);
  }, [o4, e7]), f3 = (0, import_react18.useCallback)(function(t7) {
    return null == u3 ? void 0 : u3(e7, t7);
  }, [u3, e7]);
  return (0, import_jsx_runtime3.jsx)(animated.path, { d: r4.path, opacity: r4.opacity, fill: e7.fill || r4.color, stroke: r4.borderColor, strokeWidth: r4.borderWidth, onClick: i4 ? l3 : void 0, onMouseEnter: a4 ? s4 : void 0, onMouseMove: o4 ? d3 : void 0, onMouseLeave: u3 ? f3 : void 0 });
};
var nt2 = function(t7, e7, r4, i4, a4) {
  return to2([t7, e7, r4, i4], function(t8, n4, e8, r5) {
    return a4({ startAngle: t8, endAngle: n4, innerRadius: Math.max(0, e8), outerRadius: Math.max(0, r5) });
  });
};
var et2 = function(t7, n4, r4) {
  void 0 === n4 && (n4 = "innerRadius");
  var i4 = Ur(), a4 = i4.animate, o4 = i4.config, u3 = I(n4, r4);
  return { transition: useTransition(t7, { keys: function(t8) {
    return t8.id;
  }, initial: u3.update, from: u3.enter, enter: u3.update, update: u3.update, leave: u3.leave, config: o4, immediate: !a4 }), interpolate: nt2 };
};
var rt2 = function(t7) {
  var n4 = t7.center, e7 = t7.data, r4 = t7.arcGenerator, a4 = t7.borderWidth, o4 = t7.borderColor, u3 = t7.onClick, l3 = t7.onMouseEnter, s4 = t7.onMouseMove, d3 = t7.onMouseLeave, f3 = t7.transitionMode, c9 = t7.component, g3 = void 0 === c9 ? tt2 : c9, h3 = zt(), v5 = Xe(o4, h3), x5 = et2(e7, f3, { enter: function(t8) {
    return { opacity: 0, color: t8.color, borderColor: v5(t8) };
  }, update: function(t8) {
    return { opacity: 1, color: t8.color, borderColor: v5(t8) };
  }, leave: function(t8) {
    return { opacity: 0, color: t8.color, borderColor: v5(t8) };
  } }), m4 = x5.transition, y4 = x5.interpolate, k5 = g3;
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + n4[0] + "," + n4[1] + ")", children: m4(function(t8, n5) {
    return (0, import_react18.createElement)(k5, { key: n5.id, datum: n5, style: M2({}, t8, { borderWidth: a4, path: y4(t8.startAngle, t8.endAngle, t8.innerRadius, t8.outerRadius, r4) }), onClick: u3, onMouseEnter: l3, onMouseMove: s4, onMouseLeave: d3 });
  }) });
};
var it2 = function(t7, n4, e7, r4, i4, a4) {
  void 0 === a4 && (a4 = true);
  var l3 = [], s4 = Jt(Ht(r4), e7);
  l3.push([s4.x, s4.y]);
  var d3 = Jt(Ht(i4), e7);
  l3.push([d3.x, d3.y]);
  for (var f3 = Math.round(Math.min(r4, i4)); f3 <= Math.round(Math.max(r4, i4)); f3++) if (f3 % 90 == 0) {
    var c9 = Jt(Ht(f3), e7);
    l3.push([c9.x, c9.y]);
  }
  ...
  var g3 = l3.map(function(t8) {
    ...
    return t8[1];
  }), h3 = Math.min.apply(Math, g3), v5 = Math.max.apply(Math, g3), A4 = Math.min.apply(Math, p4);
  return { points: l3, x: h3, y: A4, width: v5 - h3, height: Math.max.apply(Math, p4) - A4 };
};
var at2 = function(t7, n4, e7, r4, i4, a4) {
  var o4 = Mn(i4, a4, t7, n4);
  return o4 < e7 && o4 > r4;
};
var ot2 = function(t7, n4, e7, r4, i4, a4, o4) {
  if (at2(t7, n4, e7, r4, a4, o4)) {
    var u3 = Pn(a4, o4, t7, n4);
...
var lt = function(t7) {
  var n4 = void 0 === t7 ? {} : t7, e7 = n4.cornerRadius, r4 = void 0 === e7 ? 0 : e7, i4 = n4.padAngle, a4 = void 0 === i4 ? 0 : i4;
  return (0, import_react18.useMemo)(function() {
    return arc_default().innerRadius(function(t8) {
      return t8.innerRadius;
    }).outerRadius(function(t8) {
      return t8.outerRadius;
    }).cornerRadius(r4).padAngle(a4);
  }, [r4, a4]);
};
...
var f2 = function(e7) {
  var i4 = e7.x, n4 = e7.y, o4 = e7.size, r4 = e7.fill, l3 = e7.opacity, a4 = void 0 === l3 ? 1 : l3, c9 = e7.borderWidth, d3 = void 0 === c9 ? 0 : c9, s4 = e7.borderColor;
  return (0, import_jsx_runtime4.jsx)("circle", { r: o4 / 2, cx: i4 + o4 / 2, cy: n4 + o4 / 2, fill: r4, opacity: a4, strokeWidth: d3, stroke: void 0 === s4 ? "transparent" : s4, style: { pointerEvents: "none" } });
};
var m3 = function(e7) {
  var i4 = e7.x, n4 = e7.y, o4 = e7.size, r4 = e7.fill, l3 = e7.opacity, a4 = void 0 === l3 ? 1 : l3, c9 = e7.borderWidth, d3 = void 0 === c9 ? 0 : c9, s4 = e7.borderColor;
  return (0, import_jsx_runtime4.jsx)("g", { transform: "translate(" + i4 + "," + n4 + ")", children: (0, import_jsx_runtime4.jsx)("path", { d: "\n                    M" + o4 / 2 + " 0\n                    L" + 0.8 * o4 + " " + o4 / 2 + "\n                    L" + o4 / 2 + " " + o4 + "\n                    L" + 0.2 * o4 + " " + o4 / 2 + "\n                    L" + o4 / 2 + " 0\n                ", fill: r4, opacity: a4, strokeWidth: d3, stroke: void 0 === s4 ? "transparent" : s4, style: { pointerEvents: "none" } }) });
};
var v4 = function(e7) {
  var i4 = e7.x, n4 = e7.y, o4 = e7.size, r4 = e7.fill, l3 = e7.opacity, a4 = void 0 === l3 ? 1 : l3, c9 = e7.borderWidth, d3 = void 0 === c9 ? 0 : c9, s4 = e7.borderColor;
  return (0, import_jsx_runtime4.jsx)("rect", { x: i4, y: n4, fill: r4, opacity: a4, strokeWidth: d3, stroke: void 0 === s4 ? "transparent" : s4, width: o4, height: o4, style: { pointerEvents: "none" } });
};
var u2 = function(e7) {
  var i4 = e7.x, n4 = e7.y, o4 = e7.size, r4 = e7.fill, l3 = e7.opacity, a4 = void 0 === l3 ? 1 : l3, c9 = e7.borderWidth, d3 = void 0 === c9 ? 0 : c9, s4 = e7.borderColor;
  return (0, import_jsx_runtime4.jsx)("g", { transform: "translate(" + i4 + "," + n4 + ")", children: (0, import_jsx_runtime4.jsx)("path", { d: "\n                M" + o4 / 2 + " 0\n                L" + o4 + " " + o4 + "\n                L0 " + o4 + "\n                L" + o4 / 2 + " 0\n            ", fill: r4, opacity: a4, strokeWidth: d3, stroke: void 0 === s4 ? "transparent" : s4, style: { pointerEvents: "none" } }) });
...
function p3() {
  return p3 = Object.assign ? Object.assign.bind() : function(t7) {
    for (var e7 = 1; e7 < arguments.length; e7++) {
      var i4 = arguments[e7];
      for (var n4 in i4) Object.prototype.hasOwnProperty.call(i4, n4) && (t7[n4] = i4[n4]);
    }
    return t7;
...
var x4 = function(t7) {
  var e7, i4 = t7.direction, n4 = t7.itemsSpacing, o4 = t7.padding, r4 = t7.itemCount, l3 = t7.itemWidth, a4 = t7.itemHeight;
  if ("number" != typeof o4 && ("object" != typeof (e7 = o4) || Array.isArray(e7) || null === e7)) throw new Error("Invalid property padding, must be one of: number, object");
  var c9 = "number" == typeof o4 ? { top: o4, right: o4, bottom: o4, left: o4 } : p3({}, k4, o4), d3 = c9.left + c9.right, s4 = c9.top + c9.bottom, h3 = l3 + d3, g3 = a4 + s4, f3 = (r4 - 1) * n4;
  return "row" === i4 ? h3 = l3 * r4 + f3 + d3 : "column" === i4 && (g3 = a4 * r4 + f3 + s4), { width: h3, height: g3, padding: c9 };
};
var b3 = function(t7) {
  var e7 = t7.anchor, i4 = t7.translateX, n4 = t7.translateY, o4 = t7.containerWidth, r4 = t7.containerHeight, l3 = t7.width, a4 = t7.height, c9 = i4, d3 = n4;
  switch (e7) {
    case "top":
      c9 += (o4 - l3) / 2;
      break;
    ...
    case "left":
      ...
      break;
    case "center":
      c9 += (o4 - l3) / 2, d3 += (r4 - a4) / 2;
  }
  return { x: c9, y: d3 };
};
var S2 = function(t7) {
  var e7, i4, n4, o4, r4, l3, a4 = t7.direction, c9 = t7.justify, d3 = t7.symbolSize, s4 = t7.symbolSpacing, h3 = t7.width, g3 = t7.height;
  switch (a4) {
    case "left-to-right":
      e7 = 0, i4 = (g3 - d3) / 2, o4 = g3 / 2, l3 = "central", c9 ? (n4 = h3, r4 = "end") : (n4 = d3 + s4, r4 = "start");
      break;
    case "right-to-left":
      e7 = h3 - d3, i4 = (g3 - d3) / 2, o4 = g3 / 2, l3 = "central", c9 ? (n4 = 0, r4 = "start") : (n4 = h3 - d3 - s4, r4 = "end");
      break;
    case "top-to-bottom":
      e7 = (h3 - d3) / 2, i4 = 0, n4 = h3 / 2, r4 = "middle", c9 ? (o4 = g3, l3 = "alphabetic") : (o4 = d3 + s4, l3 = "text-before-edge");
      break;
    case "bottom-to-top":
      e7 = (h3 - d3) / 2, i4 = g3 - d3, n4 = h3 / 2, r4 = "middle", c9 ? (o4 = 0, l3 = "text-before-edge") : (o4 = g3 - d3 - s4, l3 = "alphabetic");
  }
...
var X2 = function(i4) {
  var n4, l3, a4, d3, g3, f3, m4, v5, u3, y4, k5, x5 = i4.x, b4 = i4.y, A4 = i4.width, W4 = i4.height, z5 = i4.data, C5 = i4.direction, X4 = void 0 === C5 ? "left-to-right" : C5, Y4 = i4.justify, O4 = void 0 !== Y4 && Y4, B4 = i4.textColor, H4 = i4.background, E5 = void 0 === H4 ? "transparent" : H4, j4 = i4.opacity, L2 = void 0 === j4 ? 1 : j4, M3 = i4.symbolShape, F3 = void 0 === M3 ? "square" : M3, T3 = i4.symbolSize, P3 = void 0 === T3 ? 16 : T3, V3 = i4.symbolSpacing, R = void 0 === V3 ? 8 : V3, D3 = i4.symbolBorderWidth, q4 = void 0 === D3 ? 0 : D3, G2 = i4.symbolBorderColor, I2 = void 0 === G2 ? "transparent" : G2, N4 = i4.onClick, _2 = i4.onMouseEnter, J3 = i4.onMouseLeave, K4 = i4.toggleSerie, Q3 = i4.effects, U3 = (0, import_react19.useState)({}), Z2 = U3[0], $2 = U3[1], tt3 = zt(), et3 = (0, import_react19.useCallback)(function(t7) {
    if (Q3) {
      var e7 = Q3.filter(function(t8) {
        return "hover" === t8.on;
    ...
    null == _2 || _2(z5, t7);
  }, [_2, z5, Q3]), it3 = (0, import_react19.useCallback)(function(t7) {
    if (Q3) {
      var e7 = Q3.filter(function(t8) {
        return "hover" !== t8.on;
      }).reduce(function(t8, e8) {
    ...
    null == J3 || J3(z5, t7);
  }, [J3, z5, Q3]), nt3 = S2({ direction: X4, justify: O4, symbolSize: null != (n4 = Z2.symbolSize) ? n4 : P3, symbolSpacing: R, width: A4, height: W4 }), ot3 = nt3.symbolX, rt3 = nt3.symbolY, lt2 = nt3.labelX, at3 = nt3.labelY, ct2 = nt3.labelAnchor, dt2 = nt3.labelAlignment, st = [N4, _2, J3, K4].some(function(t7) {
    return void 0 !== t7;
  }), ht2 = "function" == typeof F3 ? F3 : w3[F3];
  return (0, import_jsx_runtime4.jsxs)("g", { transform: "translate(" + x5 + "," + b4 + ")", style: { opacity: null != (l3 = Z2.itemOpacity) ? l3 : L2 }, children: [(0, import_jsx_runtime4.jsx)("rect", { width: A4, height: W4, fill: null != (a4 = Z2.itemBackground) ? a4 : E5, style: { cursor: st ? "pointer" : "auto" }, onClick: function(t7) {
    null == N4 || N4(z5, t7), null == K4 || K4(z5.id);
  }, onMouseEnter: et3, onMouseLeave: it3 }), c8.createElement(ht2, p3({ id: z5.id, x: ot3, y: rt3, size: null != (d3 = Z2.symbolSize) ? d3 : P3, fill: null != (g3 = null != (f3 = z5.fill) ? f3 : z5.color) ? g3 : "black", borderWidth: null != (m4 = Z2.symbolBorderWidth) ? m4 : q4, borderColor: null != (v5 = Z2.symbolBorderColor) ? v5 : I2 }, z5.hidden ? tt3.legends.hidden.symbol : void 0)), (0, import_jsx_runtime4.jsx)("text", { textAnchor: ct2, style: p3({}, Mt(tt3.legends.text), { fill: null != (u3 = null != (y4 = null != (k5 = Z2.itemTextColor) ? k5 : B4) ? y4 : tt3.legends.text.fill) ? u3 : "black", dominantBaseline: dt2, pointerEvents: "none", userSelect: "none" }, z5.hidden ? tt3.legends.hidden.text : void 0), x: lt2, y: at3, children: z5.label })] });
};
var Y2 = function(e7) {
  var i4 = e7.data, n4 = e7.x, o4 = e7.y, r4 = e7.direction, l3 = e7.padding, a4 = void 0 === l3 ? 0 : l3, c9 = e7.justify, d3 = e7.effects, s4 = e7.itemWidth, h3 = e7.itemHeight, g3 = e7.itemDirection, f3 = void 0 === g3 ? "left-to-right" : g3, m4 = e7.itemsSpacing, v5 = void 0 === m4 ? 0 : m4, u3 = e7.itemTextColor, p4 = e7.itemBackground, y4 = void 0 === p4 ? "transparent" : p4, k5 = e7.itemOpacity, b4 = void 0 === k5 ? 1 : k5, S4 = e7.symbolShape, A4 = e7.symbolSize, W4 = e7.symbolSpacing, z5 = e7.symbolBorderWidth, C5 = e7.symbolBorderColor, w4 = e7.onClick, Y4 = e7.onMouseEnter, O4 = e7.onMouseLeave, B4 = e7.toggleSerie, H4 = x4({ itemCount: i4.length, itemWidth: s4, itemHeight: h3, itemsSpacing: v5, direction: r4, padding: a4 }).padding, E5 = "row" === r4 ? s4 + v5 : 0, j4 = "column" === r4 ? h3 + v5 : 0;
  return (0, import_jsx_runtime4.jsx)("g", { transform: "translate(" + n4 + "," + o4 + ")", children: i4.map(function(e8, i5) {
    return (0, import_jsx_runtime4.jsx)(X2, { data: e8, x: i5 * E5 + H4.left, y: i5 * j4 + H4.top, width: s4, height: h3, direction: f3, justify: c9, effects: d3, textColor: u3, background: y4, opacity: b4, symbolShape: S4, symbolSize: A4, symbolSpacing: W4, symbolBorderWidth: z5, symbolBorderColor: C5, onClick: w4, onMouseEnter: Y4, onMouseLeave: O4, toggleSerie: B4 }, i5);
  }) });
};
var O3 = function(e7) {
  var i4 = e7.data, n4 = e7.containerWidth, o4 = e7.containerHeight, r4 = e7.translateX, l3 = void 0 === r4 ? 0 : r4, a4 = e7.translateY, c9 = void 0 === a4 ? 0 : a4, d3 = e7.anchor, s4 = e7.direction, h3 = e7.padding, g3 = void 0 === h3 ? 0 : h3, f3 = e7.justify, m4 = e7.itemsSpacing, v5 = void 0 === m4 ? 0 : m4, u3 = e7.itemWidth, p4 = e7.itemHeight, y4 = e7.itemDirection, k5 = e7.itemTextColor, S4 = e7.itemBackground, A4 = e7.itemOpacity, W4 = e7.symbolShape, z5 = e7.symbolSize, C5 = e7.symbolSpacing, w4 = e7.symbolBorderWidth, X4 = e7.symbolBorderColor, O4 = e7.onClick, B4 = e7.onMouseEnter, H4 = e7.onMouseLeave, E5 = e7.toggleSerie, j4 = e7.effects, L2 = x4({ itemCount: i4.length, itemsSpacing: v5, itemWidth: u3, itemHeight: p4, direction: s4, padding: g3 }), M3 = L2.width, F3 = L2.height, T3 = b3({ anchor: d3, translateX: l3, translateY: c9, containerWidth: n4, containerHeight: o4, width: M3, height: F3 }), P3 = T3.x, V3 = T3.y;
  return (0, import_jsx_runtime4.jsx)(Y2, { data: i4, x: P3, y: V3, direction: s4, padding: g3, justify: f3, effects: j4, itemsSpacing: v5, itemWidth: u3, itemHeight: p4, itemDirection: y4, itemTextColor: k5, itemBackground: S4, itemOpacity: A4, symbolShape: W4, symbolSize: z5, symbolSpacing: C5, symbolBorderWidth: w4, symbolBorderColor: X4, onClick: O4, onMouseEnter: B4, onMouseLeave: H4, toggleSerie: "boolean" == typeof E5 ? void 0 : E5 });
};
var B3 = { start: "left", middle: "center", end: "right" };
var H2 = function(t7, e7) {
  var i4 = e7.data, n4 = e7.containerWidth, o4 = e7.containerHeight, r4 = e7.translateX, l3 = void 0 === r4 ? 0 : r4, a4 = e7.translateY, c9 = void 0 === a4 ? 0 : a4, d3 = e7.anchor, s4 = e7.direction, h3 = e7.padding, g3 = void 0 === h3 ? 0 : h3, f3 = e7.justify, m4 = void 0 !== f3 && f3, v5 = e7.itemsSpacing, u3 = void 0 === v5 ? 0 : v5, p4 = e7.itemWidth, y4 = e7.itemHeight, k5 = e7.itemDirection, A4 = void 0 === k5 ? "left-to-right" : k5, W4 = e7.itemTextColor, z5 = e7.symbolSize, C5 = void 0 === z5 ? 16 : z5, w4 = e7.symbolSpacing, X4 = void 0 === w4 ? 8 : w4, Y4 = e7.theme, O4 = x4({ itemCount: i4.length, itemWidth: p4, itemHeight: y4, itemsSpacing: u3, direction: s4, padding: g3 }), H4 = O4.width, E5 = O4.height, j4 = O4.padding, L2 = b3({ anchor: d3, translateX: l3, translateY: c9, containerWidth: n4, containerHeight: o4, width: H4, height: E5 }), M3 = L2.x, F3 = L2.y, T3 = "row" === s4 ? p4 + u3 : 0, P3 = "column" === s4 ? y4 + u3 : 0;
  t7.save(), t7.translate(M3, F3), t7.font = Y4.legends.text.fontSize + "px " + (Y4.legends.text.fontFamily || "sans-serif"), i4.forEach(function(e8, i5) {
    var n5, o5, r5 = i5 * T3 + j4.left, l4 = i5 * P3 + j4.top, a5 = S2({ direction: A4, justify: m4, symbolSize: C5, symbolSpacing: X4, width: p4, height: y4 }), c10 = a5.symbolX, d4 = a5.symbolY, s5 = a5.labelX, h4 = a5.labelY, g4 = a5.labelAnchor, f4 = a5.labelAlignment;
    t7.fillStyle = null != (n5 = e8.color) ? n5 : "black", t7.fillRect(r5 + c10, l4 + d4, C5, C5), t7.textAlign = B3[g4], "central" === f4 && (t7.textBaseline = "middle"), t7.fillStyle = null != (o5 = null != W4 ? W4 : Y4.legends.text.fill) ? o5 : "black", t7.fillText(String(e8.label), r5 + s5, l4 + h4);
  }), t7.restore();
};
...
function E4() {
  return E4 = Object.assign ? Object.assign.bind() : function(e7) {
    for (var t7 = 1; t7 < arguments.length; t7++) {
      var i4 = arguments[t7];
      for (var n4 in i4) Object.prototype.hasOwnProperty.call(i4, n4) && (e7[n4] = i4[n4]);
    }
    return e7;
...
function F2(e7, t7) {
  if (null == e7) return {};
  var i4, n4, a4 = {}, r4 = Object.keys(e7);
  for (n4 = 0; n4 < r4.length; n4++) i4 = r4[n4], t7.indexOf(i4) >= 0 || (a4[i4] = e7[i4]);
  return a4;
}
var H3;
var X3 = function(e7) {
  var t7 = e7.width, i4 = e7.height, n4 = e7.legends, a4 = e7.data, r4 = e7.toggleSerie;
  return (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: n4.map(function(e8, n5) {
    var o4;
    return (0, import_jsx_runtime5.jsx)(O3, E4({}, e8, { containerWidth: t7, containerHeight: i4, data: null != (o4 = e8.data) ? o4 : a4, toggleSerie: e8.toggleSerie ? r4 : void 0 }), n5);
  }) });
};
...
var j3 = ["points"];
var P2 = function(t7) {
  var i4 = t7.data, n4 = t7.id, a4 = void 0 === n4 ? Y3.id : n4, r4 = t7.value, o4 = void 0 === r4 ? Y3.value : r4, s4 = t7.valueFormat, c9 = t7.colors, u3 = void 0 === c9 ? Y3.colors : c9, v5 = Wn(a4), f3 = Wn(o4), g3 = Ot(s4), L2 = pr(u3, "id");
  return (0, import_react20.useMemo)(function() {
    return i4.map(function(e7) {
      var t8, i5 = v5(e7), n5 = f3(e7), a5 = { id: i5, label: null != (t8 = e7.label) ? t8 : i5, hidden: false, value: n5, formattedValue: g3(n5), data: e7 };
      return E4({}, a5, { color: L2(a5) });
    });
  }, [i4, v5, f3, g3, L2]);
};
var q3 = function(n4) {
  var a4 = n4.data, r4 = n4.startAngle, o4 = n4.endAngle, d3 = n4.innerRadius, l3 = n4.outerRadius, u3 = n4.padAngle, v5 = n4.sortByValue, f3 = n4.activeId, g3 = n4.activeInnerRadiusOffset, L2 = n4.activeOuterRadiusOffset, h3 = n4.hiddenIds, b4 = n4.forwardLegendData, A4 = (0, import_react20.useMemo)(function() {
    var e7 = pie_default().value(function(e8) {
      return e8.value;
    }).startAngle(Ht(r4)).endAngle(Ht(o4)).padAngle(Ht(u3));
    return v5 || e7.sortValues(null), e7;
  }, [r4, o4, u3, v5]), p4 = (0, import_react20.useMemo)(function() {
    var e7 = a4.filter(function(e8) {
      return !h3.includes(e8.id);
    });
    return { dataWithArc: A4(e7).map(function(e8) {
      var t7 = Math.abs(e8.endAngle - e8.startAngle);
      return E4({}, e8.data, { arc: { index: e8.index, startAngle: e8.startAngle, endAngle: e8.endAngle, innerRadius: f3 === e8.data.id ? d3 - g3 : d3, outerRadius: f3 === e8.data.id ? l3 + L2 : l3, thickness: l3 - d3, padAngle: e8.padAngle, angle: t7, angleDeg: Kt(t7) } });
    }), legendData: a4.map(function(e8) {
      return { id: e8.id, label: e8.label, color: e8.color, hidden: h3.includes(e8.id), data: e8 };
    }) };
  }, [A4, a4, h3, f3, d3, g3, l3, L2]), k5 = p4.legendData, I2 = (0, import_react20.useRef)(b4);
...
var J2 = function(e7) {
  var t7 = e7.data, i4 = e7.radius, r4 = e7.innerRadius, o4 = e7.startAngle, d3 = void 0 === o4 ? Y3.startAngle : o4, l3 = e7.endAngle, c9 = void 0 === l3 ? Y3.endAngle : l3, u3 = e7.padAngle, v5 = void 0 === u3 ? Y3.padAngle : u3, f3 = e7.sortByValue, g3 = void 0 === f3 ? Y3.sortByValue : f3, L2 = e7.cornerRadius, h3 = void 0 === L2 ? Y3.cornerRadius : L2, b4 = e7.activeInnerRadiusOffset, p4 = void 0 === b4 ? Y3.activeInnerRadiusOffset : b4, k5 = e7.activeOuterRadiusOffset, I2 = void 0 === k5 ? Y3.activeOuterRadiusOffset : k5, R = e7.activeId, m4 = e7.onActiveIdChange, O4 = e7.defaultActiveId, C5 = e7.forwardLegendData, x5 = z4({ activeId: R, onActiveIdChange: m4, defaultActiveId: O4 }), w4 = x5.activeId, M3 = x5.setActiveId, y4 = (0, import_react20.useState)([]), W4 = y4[0], S4 = y4[1], T3 = q3({ data: t7, startAngle: d3, endAngle: c9, innerRadius: r4, outerRadius: i4, padAngle: v5, sortByValue: g3, activeId: w4, activeInnerRadiusOffset: p4, activeOuterRadiusOffset: I2, hiddenIds: W4, forwardLegendData: C5 }), D3 = (0, import_react20.useCallback)(function(e8) {
    S4(function(t8) {
  ...
  return E4({}, T3, { arcGenerator: lt({ cornerRadius: h3, padAngle: Ht(v5) }), setActiveId: M3, toggleSerie: D3 });
};
var K3 = function(t7) {
  var i4 = t7.data, r4 = t7.width, o4 = t7.height, d3 = t7.innerRadius, l3 = void 0 === d3 ? Y3.innerRadius : d3, c9 = t7.startAngle, u3 = void 0 === c9 ? Y3.startAngle : c9, v5 = t7.endAngle, f3 = void 0 === v5 ? Y3.endAngle : v5, g3 = t7.padAngle, L2 = void 0 === g3 ? Y3.padAngle : g3, h3 = t7.sortByValue, b4 = void 0 === h3 ? Y3.sortByValue : h3, k5 = t7.cornerRadius, I2 = void 0 === k5 ? Y3.cornerRadius : k5, R = t7.fit, m4 = void 0 === R ? Y3.fit : R, O4 = t7.activeInnerRadiusOffset, C5 = void 0 === O4 ? Y3.activeInnerRadiusOffset : O4, x5 = t7.activeOuterRadiusOffset, w4 = void 0 === x5 ? Y3.activeOuterRadiusOffset : x5, M3 = t7.activeId, y4 = t7.onActiveIdChange, W4 = t7.defaultActiveId, S4 = t7.forwardLegendData, T3 = z4({ activeId: M3, onActiveIdChange: y4, defaultActiveId: W4 }), D3 = T3.activeId, V3 = T3.setActiveId, B4 = (0, import_react20.useState)([]), G2 = B4[0], H4 = B4[1], X4 = (0, import_react20.useMemo)(function() {
    var e7, t8 = Math.min(r4, o4) / 2, i5 = t8 * Math.min(l3, 1), n4 = r4 / 2, a4 = o4 / 2;
    if (m4) {
      var d4 = it2(n4, a4, t8, u3 - 90, f3 - 90), s4 = d4.points, c10 = F2(d4, j3), v6 = Math.min(r4 / c10.width, o4 / c10.height), g4 = { width: c10.width * v6, height: c10.height * v6 };
      g4.x = (r4 - g4.width) / 2, g4.y = (o4 - g4.height) / 2, n4 = (n4 - c10.x) / c10.width * c10.width * v6 + g4.x, a4 = (a4 - c10.y) / c10.height * c10.height * v6 + g4.y, e7 = { box: c10, ratio: v6, points: s4 }, t8 *= v6, i5 *= v6;
    }
    return { centerX: n4, centerY: a4, radius: t8, innerRadius: i5, debug: e7 };
  }, [r4, o4, l3, u3, f3, m4]), P3 = q3({ data: i4, startAngle: u3, endAngle: f3, innerRadius: X4.innerRadius, outerRadius: X4.radius, padAngle: L2, sortByValue: b4, activeId: D3, activeInnerRadiusOffset: C5, activeOuterRadiusOffset: w4, hiddenIds: G2, forwardLegendData: S4 }), J3 = (0, import_react20.useCallback)(function(e7) {
    H4(function(t8) {
  ...
  return E4({ arcGenerator: lt({ cornerRadius: I2, padAngle: Ht(L2) }), activeId: D3, setActiveId: V3, toggleSerie: J3 }, P3, X4);
};
var N3 = function(t7) {
  var i4 = t7.dataWithArc, n4 = t7.arcGenerator, a4 = t7.centerX, r4 = t7.centerY, o4 = t7.radius, d3 = t7.innerRadius;
  return (0, import_react20.useMemo)(function() {
    return { dataWithArc: i4, arcGenerator: n4, centerX: a4, centerY: r4, radius: o4, innerRadius: d3 };
  }, [i4, n4, a4, r4, o4, d3]);
};
var Q2 = function(t7) {
  var i4 = t7.center, n4 = t7.data, a4 = t7.arcGenerator, o4 = t7.borderWidth, d3 = t7.borderColor, l3 = t7.isInteractive, s4 = t7.onClick, c9 = t7.onMouseEnter, u3 = t7.onMouseMove, v5 = t7.onMouseLeave, f3 = t7.setActiveId, g3 = t7.tooltip, L2 = t7.transitionMode, h3 = k(), b4 = h3.showTooltipFromEvent, A4 = h3.hideTooltip, p4 = (0, import_react20.useMemo)(function() {
    if (l3) return function(e7, t8) {
      null == s4 || s4(e7, t8);
    };
  }, [l3, s4]), I2 = (0, import_react20.useMemo)(function() {
    if (l3) return function(e7, t8) {
      b4((0, import_react20.createElement)(g3, { datum: e7 }), t8), f3(e7.id), null == c9 || c9(e7, t8);
    };
  }, [l3, b4, f3, c9, g3]), R = (0, import_react20.useMemo)(function() {
    if (l3) return function(e7, t8) {
      b4((0, import_react20.createElement)(g3, { datum: e7 }), t8), null == u3 || u3(e7, t8);
    };
  }, [l3, b4, u3, g3]), m4 = (0, import_react20.useMemo)(function() {
    if (l3) return function(e7, t8) {
      A4(), f3(null), null == v5 || v5(e7, t8);
    };
  }, [l3, A4, f3, v5]);
  return (0, import_jsx_runtime5.jsx)(rt2, { center: i4, data: n4, arcGenerator: a4, borderWidth: o4, borderColor: d3, transitionMode: L2, onClick: p4, onMouseEnter: I2, onMouseMove: R, onMouseLeave: m4 });
};
var U2 = ["isInteractive", "animate", "motionConfig", "theme", "renderWrapper"];
var Z = function(e7) {
  var t7 = e7.data, i4 = e7.id, n4 = void 0 === i4 ? Y3.id : i4, a4 = e7.value, d3 = void 0 === a4 ? Y3.value : a4, l3 = e7.valueFormat, s4 = e7.sortByValue, c9 = void 0 === s4 ? Y3.sortByValue : s4, u3 = e7.layers, L2 = void 0 === u3 ? Y3.layers : u3, h3 = e7.startAngle, b4 = void 0 === h3 ? Y3.startAngle : h3, A4 = e7.endAngle, p4 = void 0 === A4 ? Y3.endAngle : A4, k5 = e7.padAngle, m4 = void 0 === k5 ? Y3.padAngle : k5, O4 = e7.fit, C5 = void 0 === O4 ? Y3.fit : O4, x5 = e7.innerRadius, w4 = void 0 === x5 ? Y3.innerRadius : x5, M3 = e7.cornerRadius, y4 = void 0 === M3 ? Y3.cornerRadius : M3, S4 = e7.activeInnerRadiusOffset, T3 = void 0 === S4 ? Y3.activeInnerRadiusOffset : S4, D3 = e7.activeOuterRadiusOffset, V3 = void 0 === D3 ? Y3.activeOuterRadiusOffset : D3, B4 = e7.width, G2 = e7.height, E5 = e7.margin, F3 = e7.colors, H4 = void 0 === F3 ? Y3.colors : F3, j4 = e7.borderWidth, q4 = void 0 === j4 ? Y3.borderWidth : j4, z5 = e7.borderColor, J3 = void 0 === z5 ? Y3.borderColor : z5, U3 = e7.enableArcLabels, Z2 = void 0 === U3 ? Y3.enableArcLabels : U3, $2 = e7.arcLabel, _2 = void 0 === $2 ? Y3.arcLabel : $2, ee2 = e7.arcLabelsSkipAngle, te2 = void 0 === ee2 ? Y3.arcLabelsSkipAngle : ee2, ie2 = e7.arcLabelsTextColor, ne2 = void 0 === ie2 ? Y3.arcLabelsTextColor : ie2, ae = e7.arcLabelsRadiusOffset, re2 = void 0 === ae ? Y3.arcLabelsRadiusOffset : ae, oe = e7.arcLabelsComponent, de = e7.enableArcLinkLabels, le = void 0 === de ? Y3.enableArcLinkLabels : de, se = e7.arcLinkLabel, ce = void 0 === se ? Y3.arcLinkLabel : se, ue = e7.arcLinkLabelsSkipAngle, ve = void 0 === ue ? Y3.arcLinkLabelsSkipAngle : ue, fe = e7.arcLinkLabelsOffset, ge = void 0 === fe ? Y3.arcLinkLabelsOffset : fe, Le2 = e7.arcLinkLabelsDiagonalLength, he = void 0 === Le2 ? Y3.arcLinkLabelsDiagonalLength : Le2, be = e7.arcLinkLabelsStraightLength, Ae = void 0 === be ? Y3.arcLinkLabelsStraightLength : be, pe = e7.arcLinkLabelsThickness, ke2 = void 0 === pe ? Y3.arcLinkLabelsThickness : pe, Ie = e7.arcLinkLabelsTextOffset, Re2 = void 0 === Ie ? Y3.arcLinkLabelsTextOffset : Ie, me = e7.arcLinkLabelsTextColor, Oe2 = void 0 === me ? Y3.arcLinkLabelsTextColor : me, Ce2 = e7.arcLinkLabelsColor, xe = void 0 === Ce2 ? Y3.arcLinkLabelsColor : Ce2, we2 = e7.arcLinkLabelComponent, Me2 = e7.defs, ye = void 0 === Me2 ? Y3.defs : Me2, We2 = e7.fill, Se = void 0 === We2 ? Y3.fill : We2, Te2 = e7.isInteractive, De2 = void 0 === Te2 ? Y3.isInteractive : Te2, Ve2 = e7.onClick, Be2 = e7.onMouseEnter, Ge2 = e7.onMouseMove, Ee = e7.onMouseLeave, Fe2 = e7.tooltip, He2 = void 0 === Fe2 ? Y3.tooltip : Fe2, Xe2 = e7.activeId, Ye2 = e7.onActiveIdChange, je2 = e7.defaultActiveId, Pe2 = e7.transitionMode, qe2 = void 0 === Pe2 ? Y3.transitionMode : Pe2, ze = e7.legends, Je2 = void 0 === ze ? Y3.legends : ze, Ke2 = e7.forwardLegendData, Ne2 = e7.role, Qe3 = void 0 === Ne2 ? Y3.role : Ne2, Ue2 = wt(B4, G2, E5), Ze2 = Ue2.outerWidth, $e2 = Ue2.outerHeight, _e = Ue2.margin, et3 = Ue2.innerWidth, tt3 = Ue2.innerHeight, it3 = P2({ data: t7, id: n4, value: d3, valueFormat: l3, colors: H4 }), nt3 = K3({ data: it3, width: et3, height: tt3, fit: C5, innerRadius: w4, startAngle: b4, endAngle: p4, padAngle: m4, sortByValue: c9, cornerRadius: y4, activeInnerRadiusOffset: T3, activeOuterRadiusOffset: V3, activeId: Xe2, onActiveIdChange: Ye2, defaultActiveId: je2, forwardLegendData: Ke2 }), at3 = nt3.dataWithArc, rt3 = nt3.legendData, ot3 = nt3.arcGenerator, dt2 = nt3.centerX, lt2 = nt3.centerY, st = nt3.radius, ct2 = nt3.innerRadius, ut2 = nt3.setActiveId, vt2 = nt3.toggleSerie, ft = In(ye, at3, Se), gt2 = { arcs: null, arcLinkLabels: null, arcLabels: null, legends: null };
  L2.includes("arcs") && (gt2.arcs = (0, import_jsx_runtime5.jsx)(Q2, { center: [dt2, lt2], data: at3, arcGenerator: ot3, borderWidth: q4, borderColor: J3, isInteractive: De2, onClick: Ve2, onMouseEnter: Be2, onMouseMove: Ge2, onMouseLeave: Ee, setActiveId: ut2, tooltip: He2, transitionMode: qe2 }, "arcs")), le && L2.includes("arcLinkLabels") && (gt2.arcLinkLabels = (0, import_jsx_runtime5.jsx)(U, { center: [dt2, lt2], data: at3, label: ce, skipAngle: ve, offset: ge, diagonalLength: he, straightLength: Ae, strokeWidth: ke2, textOffset: Re2, textColor: Oe2, linkColor: xe, component: we2 }, "arcLinkLabels")), Z2 && L2.includes("arcLabels") && (gt2.arcLabels = (0, import_jsx_runtime5.jsx)(B2, { center: [dt2, lt2], data: at3, label: _2, radiusOffset: re2, skipAngle: te2, textColor: ne2, transitionMode: qe2, component: oe }, "arcLabels")), Je2.length > 0 && L2.includes("legends") && (gt2.legends = (0, import_jsx_runtime5.jsx)(X3, { width: et3, height: tt3, data: rt3, legends: Je2, toggleSerie: vt2 }, "legends"));
  var Lt2 = N3({ dataWithArc: at3, arcGenerator: ot3, centerX: dt2, centerY: lt2, radius: st, innerRadius: ct2 });
  return (0, import_jsx_runtime5.jsx)(gn, { width: Ze2, height: $e2, margin: _e, defs: ft, role: Qe3, children: L2.map(function(e8, t8) {
...
var $ = function(e7) {
  var t7 = e7.isInteractive, i4 = void 0 === t7 ? Y3.isInteractive : t7, n4 = e7.animate, a4 = void 0 === n4 ? Y3.animate : n4, r4 = e7.motionConfig, o4 = void 0 === r4 ? Y3.motionConfig : r4, d3 = e7.theme, l3 = e7.renderWrapper, s4 = F2(e7, U2);
  return (0, import_jsx_runtime5.jsx)(St, { animate: a4, isInteractive: i4, motionConfig: o4, renderWrapper: l3, theme: d3, children: (0, import_jsx_runtime5.jsx)(Z, E4({ isInteractive: i4 }, s4)) });
};
var _ = function(e7) {
  return (0, import_jsx_runtime5.jsx)(It, { children: function(t7) {
    var i4 = t7.width, n4 = t7.height;
    return (0, import_jsx_runtime5.jsx)($, E4({ width: i4, height: n4 }, e7));
  } });
};
var ee = ["isInteractive", "theme", "renderWrapper"];
var te = function(n4) {
  var a4 = n4.data, o4 = n4.id, d3 = void 0 === o4 ? Y3.id : o4, l3 = n4.value, s4 = void 0 === l3 ? Y3.value : l3, c9 = n4.valueFormat, u3 = n4.sortByValue, f3 = void 0 === u3 ? Y3.sortByValue : u3, g3 = n4.startAngle, L2 = void 0 === g3 ? Y3.startAngle : g3, A4 = n4.endAngle, p4 = void 0 === A4 ? Y3.endAngle : A4, k5 = n4.padAngle, I2 = void 0 === k5 ? Y3.padAngle : k5, R = n4.fit, M3 = void 0 === R ? Y3.fit : R, S4 = n4.innerRadius, T3 = void 0 === S4 ? Y3.innerRadius : S4, D3 = n4.cornerRadius, B4 = void 0 === D3 ? Y3.cornerRadius : D3, F3 = n4.activeInnerRadiusOffset, H4 = void 0 === F3 ? Y3.activeInnerRadiusOffset : F3, X4 = n4.activeOuterRadiusOffset, j4 = void 0 === X4 ? Y3.activeOuterRadiusOffset : X4, q4 = n4.width, z5 = n4.height, J3 = n4.margin, N4 = n4.pixelRatio, Q3 = void 0 === N4 ? Y3.pixelRatio : N4, U3 = n4.colors, Z2 = void 0 === U3 ? Y3.colors : U3, $2 = n4.borderWidth, _2 = void 0 === $2 ? Y3.borderWidth : $2, ee2 = n4.borderColor, te2 = void 0 === ee2 ? Y3.borderColor : ee2, ie2 = n4.enableArcLabels, ne2 = void 0 === ie2 ? Y3.enableArcLabels : ie2, ae = n4.arcLabel, re2 = void 0 === ae ? Y3.arcLabel : ae, oe = n4.arcLabelsSkipAngle, de = void 0 === oe ? Y3.arcLabelsSkipAngle : oe, le = n4.arcLabelsTextColor, se = void 0 === le ? Y3.arcLabelsTextColor : le, ce = n4.arcLabelsRadiusOffset, ue = void 0 === ce ? Y3.arcLabelsRadiusOffset : ce, ve = n4.enableArcLinkLabels, fe = void 0 === ve ? Y3.enableArcLinkLabels : ve, ge = n4.arcLinkLabel, Le2 = void 0 === ge ? Y3.arcLinkLabel : ge, he = n4.arcLinkLabelsSkipAngle, be = void 0 === he ? Y3.arcLinkLabelsSkipAngle : he, Ae = n4.arcLinkLabelsOffset, pe = void 0 === Ae ? Y3.arcLinkLabelsOffset : Ae, ke2 = n4.arcLinkLabelsDiagonalLength, Ie = void 0 === ke2 ? Y3.arcLinkLabelsDiagonalLength : ke2, Re2 = n4.arcLinkLabelsStraightLength, me = void 0 === Re2 ? Y3.arcLinkLabelsStraightLength : Re2, Oe2 = n4.arcLinkLabelsThickness, Ce2 = void 0 === Oe2 ? Y3.arcLinkLabelsThickness : Oe2, xe = n4.arcLinkLabelsTextOffset, we2 = void 0 === xe ? Y3.arcLinkLabelsTextOffset : xe, Me2 = n4.arcLinkLabelsTextColor, ye = void 0 === Me2 ? Y3.arcLinkLabelsTextColor : Me2, We2 = n4.arcLinkLabelsColor, Se = void 0 === We2 ? Y3.arcLinkLabelsColor : We2, Te2 = n4.isInteractive, De2 = void 0 === Te2 ? Y3.isInteractive : Te2, Ve2 = n4.onClick, Be2 = n4.onMouseMove, Ge2 = n4.tooltip, Ee = void 0 === Ge2 ? Y3.tooltip : Ge2, Fe2 = n4.activeId, He2 = n4.onActiveIdChange, Xe2 = n4.defaultActiveId, Ye2 = n4.legends, je2 = void 0 === Ye2 ? Y3.legends : Ye2, Pe2 = n4.forwardLegendData, qe2 = (0, import_react20.useRef)(null), ze = zt(), Je2 = wt(q4, z5, J3), Ke2 = Je2.margin, Ne2 = Je2.innerWidth, Qe3 = Je2.innerHeight, Ue2 = Je2.outerWidth, Ze2 = Je2.outerHeight, $e2 = P2({ data: a4, id: d3, value: s4, valueFormat: c9, colors: Z2 }), _e = K3({ data: $e2, width: Ne2, height: Qe3, fit: M3, innerRadius: T3, startAngle: L2, endAngle: p4, padAngle: I2, sortByValue: f3, cornerRadius: B4, activeInnerRadiusOffset: H4, activeOuterRadiusOffset: j4, activeId: Fe2, onActiveIdChange: He2, defaultActiveId: Xe2, forwardLegendData: Pe2 }), et3 = _e.dataWithArc, tt3 = _e.arcGenerator, it3 = _e.centerX, nt3 = _e.centerY, at3 = _e.radius, rt3 = _e.innerRadius, ot3 = _e.setActiveId, dt2 = Xe(te2, ze), lt2 = z3({ data: et3, label: re2, skipAngle: de, offset: ue, textColor: se }), st = Y({ data: et3, skipAngle: be, offset: pe, diagonalLength: Ie, straightLength: me, label: Le2, linkColor: Se, textOffset: we2, textColor: ye });
  (0, import_react20.useEffect)(function() {
    if (qe2.current) {
      qe2.current.width = Ue2 * Q3, qe2.current.height = Ze2 * Q3;
      var e7 = qe2.current.getContext("2d");
      e7.scale(Q3, Q3), e7.fillStyle = ze.background, e7.fillRect(0, 0, Ue2, Ze2), e7.save(), e7.translate(Ke2.left, Ke2.top), tt3.context(e7), e7.save(), e7.translate(it3, nt3), et3.forEach(function(t7) {
        e7.beginPath(), e7.fillStyle = t7.color, e7.strokeStyle = dt2(t7), e7.lineWidth = _2, tt3(t7.arc), e7.fill(), _2 > 0 && e7.stroke();
      }), true === fe && V2(e7, st, ze, Ce2), true === ne2 && w2(e7, lt2, ze), e7.restore(), je2.forEach(function(t7) {
        H2(e7, E4({}, t7, { data: et3, containerWidth: Ne2, containerHeight: Qe3, theme: ze }));
      });
    }
  }, [qe2, Ne2, Qe3, Ue2, Ze2, Ke2.top, Ke2.left, Q3, it3, nt3, tt3, et3, _2, dt2, ne2, lt2, fe, st, Ce2, je2, ze]);
  var ct2 = (0, import_react20.useMemo)(function() {
    return et3.map(function(e7) {
      return E4({ id: e7.id }, e7.arc);
    });
  }, [et3]), ut2 = function(e7) {
    if (!qe2.current) return null;
    var t7 = Sn(qe2.current, e7), i4 = t7[0], n5 = t7[1], a5 = ot2(Ke2.left + it3, Ke2.top + nt3, at3, rt3, ct2, i4, n5);
    return a5 ? et3.find(function(e8) {
      return e8.id === a5.id;
    }) : null;
  }, vt2 = k(), ft = vt2.showTooltipFromEvent, gt2 = vt2.hideTooltip, Lt2 = function(e7) {
    var t7 = ut2(e7);
    t7 ? (null == Be2 || Be2(t7, e7), ot3(t7.id), ft((0, import_react20.createElement)(Ee, { datum: t7 }), e7)) : (ot3(null), gt2());
  };
...
var ie = function(e7) {
  var t7 = e7.isInteractive, i4 = void 0 === t7 ? Y3.isInteractive : t7, n4 = e7.theme, a4 = e7.renderWrapper, r4 = F2(e7, ee);
  return (0, import_jsx_runtime5.jsx)(St, { isInteractive: i4, renderWrapper: a4, theme: n4, children: (0, import_jsx_runtime5.jsx)(te, E4({ isInteractive: i4 }, r4)) });
};
var ne = function(e7) {
  return (0, import_jsx_runtime5.jsx)(It, { children: function(t7) {
    var i4 = t7.width, n4 = t7.height;
    return (0, import_jsx_runtime5.jsx)(ie, E4({ width: i4, height: n4 }, e7));
  } });
};
export {
  $ as Pie,
